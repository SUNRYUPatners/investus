...
export const MOCK_ANALYST_POSTS: AnalystMockPost[] = [
  ...
  },
  {
    ...
    content: "테슬라만 따로 보면 공기저항계수(Cd)는 차가 공기를 가르는 저항입니다. 0.2 미만이면 매우 낮은 편입니다. 전비 165와트시/마일은 1마일에 쓰는 전력이고, 테슬라 첫 전륜구동으로 설명됐습니다. 마일당 원가 의견·유타 7대와 다른 화면의 숫자입니다. 다음 확인할 것은 실도로 전비입니다.",
    likes: 16, comments: 1, created_at: "2026-09-11T00:12:00.000Z", liked: false,
  },
  {
    id: -1190, alias: "송파 독수리 #66", symbol: "TSLA",
    content: "회의록 한 줄로 정리합니다. 스트릭은 개입 없이 이어 간 구간입니다. 97.2%와 177.7마일이 한 화면에 찍혔고, 완전자율주행이 훌륭하다는 발언이 붙었습니다. 분모·개입 정의는 공시되지 않았습니다. 슬로베니아 두 달 무상과 다른 화면의 숫자입니다. 다음 확인할 것은 공개 개입률입니다.",
    likes: 17, comments: 2, created_at: "2026-09-11T00:18:00.000Z", liked: false,
  },
  {
    id: -1191, alias: "분당 매 #31", symbol: "SPCX",
    content: "캘린더 기준으로 보면 지금까지 스타십 비행은 시험에 가까웠습니다. 다음 비행이 고객 화물을 실어 돈을 받는 비행이 될 수 있다는 표현이 나왔고, 연간 반복매출 1,000억 달러 확신이 붙었습니다. 부스터 22호기 극저온 시험과 다른 화면의 숫자입니다. 1,000억 달러는 가정이지 수주 잔고가 아닙니다. 다음 확인할 것은 페이로드 고객입니다.",
    likes: 18, comments: 1, created_at: "2026-09-11T00:24:00.000Z", liked: false,
  },
  {
    id: -1192, alias: "성수 너구리 #15", symbol: "NVDA",
    content: "가정과 실측을 갈랐습니다. 엔터프라이즈 스택은 기업이 인공지능을 돌리는 소프트웨어 층입니다. 팔란티어가 그 층에서 가장 중요하다는 평가와 주권 인공지능 스택 그림이 같이 나왔습니다. 칩 판매와 소프트웨어 구독은 매출 인식이 다릅니다. 내부자 6억 달러 매도와 다른 화면의 숫자입니다. 다음 확인할 것은 공동 레퍼런스입니다.",
  ...
  },
  {
    ...
    content: "다음 게이트만 적습니다. 완전자율주행은 운전자 감독 아래 차가 차로·감속을 맡는 소프트웨어입니다. 슬로베니아에서 두 달 동안 요금 없이 쓸 수 있다는 안내가 나왔습니다. 유럽 전역 허가가 아닙니다. 97.2% 스트릭·자그레브 무인과 다른 화면의 숫자입니다. 다음 확인할 것은 유료 전환율입니다.",
    likes: 21, comments: 1, created_at: "2026-09-11T00:42:00.000Z", liked: false,
  },
  {
    id: -1195, alias: "삼성동 올빼미 #19", symbol: "SPCX",
    content: "한장으로 안 묶습니다. 콜로서스는 대규모 인공지능 학습 클러스터입니다. 122일 만에 올린 뒤 장애가 있었고, 이제는 속도보다 안정성을 우선해 설비를 다시 짜는 작업이 거론됐습니다. 재설계는 자본지출 일정이지 학습 성능 확정이 아닙니다. 테라팹 기초와 다른 화면의 숫자입니다. 다음 확인할 것은 가동률입니다.",
    likes: 14, comments: 1, created_at: "2026-09-11T00:48:00.000Z", liked: false,
  },
  {
    id: -1196, alias: "해운대 고래 #03", symbol: "SPCX",
    content: "정의부터 확인합니다. 극저온 시험은 초저온 연료를 넣어 탱크가 새지 않는지 보는 지상 시험입니다. 부스터 22호기가 통과했고, 15번째 비행에는 42호기가 거론됐습니다. 발사 허가가 아닙니다. 매출 비행 확신과 다른 화면의 숫자입니다. 다음 게이트는 정적 화재와 발사 창입니다.",
    likes: 15, comments: 2, created_at: "2026-09-11T00:54:00.000Z", liked: false,
  },
  {
    id: -1197, alias: "마포 살괭이 #08", symbol: "TSLA",
    content: "표에 숫자만 남깁니다. 보링컴퍼니는 지하 터널을 파는 회사입니다. 30억 달러 시리즈 D에 기업가치 230억 달러, 아랍에미리트 터널 150km 이상이 붙었습니다. 착공·개통 전에 기업가치를 확정 수요로 읽지 마시기 바랍니다. 테슬라 시총과 따로 보시면 됩니다. 다음 확인할 것은 착공 구간입니다.",
  ...
  },
  {
    ...
    content: "스페이스X만 따로 보면 테라팹은 대형 칩·패키지 공장 프로젝트입니다. 1단계 기초 공사가 한 달 전 사진보다 40~50% 더 나아갔다는 비교가 나왔습니다. 기초는 착공이지 양산이 아닙니다. 데이터센터 재설계와 다른 화면의 숫자입니다. 다음 확인할 것은 장비 반입입니다.",
    likes: 18, comments: 2, created_at: "2026-09-11T01:12:00.000Z", liked: false,
  },
  {
    id: -1200, alias: "압구정 치타 #44", symbol: "NVDA",
    content: "회의록 한 줄로 정리합니다. 포니에이아이는 중국 로보택시 회사이고 베르네는 유럽 파트너입니다. 크로아티아 자그레브 일반도로 22km를 운전자 없이 달렸고, 엔비디아 드라이브가 붙었습니다. 유럽 첫 사례로 설명됐습니다. 테슬라 사이버캡 배치와 다른 화면의 숫자입니다. 다음 확인할 것은 반복 운행과 요금입니다.",
    likes: 19, comments: 1, created_at: "2026-09-11T01:18:00.000Z", liked: false,
  },
  {
    id: -1201, alias: "잠실 백로 #29", symbol: "TSLA",
    content: "캘린더 기준으로 보면 라이더 가이드는 승객이 차에 타기 전 읽는 안내서입니다. 북미용 사이버캡 안내서가 2026년 9월 4일 날짜로 공개됐습니다. 유료 호출 확정이 아닙니다. 앱 색·유타 7대와 다른 화면의 숫자입니다. 다음 확인할 것은 호출이 열리는 도시입니다.",
    likes: 20, comments: 1, created_at: "2026-09-11T01:24:00.000Z", liked: false,
  },
  {
    id: -1202, alias: "청담 여우 #11", symbol: "TSLA",
    content: "가정과 실측을 갈랐습니다. 플레전트그로브는 유타의 도시입니다. 핸들이 달린 사이버캡 7대가 보였고, 로보택시 앱에는 아직 안 올라왔다는 설명이 붙었습니다. 텍사스 등록 집계와 다른 화면의 숫자입니다. 핸들 있는 차는 시험·이동용일 수 있습니다. 다음 확인할 것은 유타 허가입니다.",
    likes: 21, comments: 2, created_at: "2026-09-11T01:30:00.000Z", liked: false,
  },
  {
    id: -1203, alias: "합정 수달 #07", symbol: "TSLA",
    content: "리스크 칸에 먼저 씁니다. 기어트레인은 관절을 움직이는 기어·감속기 묶음입니다. 독일 홀츠게를링겐에서 옵티머스 기어트레인 제조 인력을 뽑는 공고가 나왔습니다. 채용은 공장 준비이지 출고가 아닙니다. 부품 5,000대 발주와 다른 화면의 숫자입니다. 다음 확인할 것은 라인 가동입니다.",
    likes: 14, comments: 1, created_at: "2026-09-11T01:36:00.000Z", liked: false,
  },
  {
    id: -1204, alias: "이태원 부엉이 #18", symbol: "SPCX",
    content: "다음 게이트만 적습니다. 스타링크 다이렉트는 위성에서 휴대폰으로 바로 문자를 보내는 서비스입니다. 일본을 넘어 미국·캐나다·뉴질랜드에 먼저 열리고, 이어 필리핀이 거론됐습니다. 날짜는 9월 28일입니다. 가정용 라우터 4와 다른 화면의 숫자입니다. 다음 확인할 것은 통신사 요금입니다.",
    likes: 15, comments: 1, created_at: "2026-09-11T01:42:00.000Z", liked: false,
  },
  {
    id: -1205, alias: "성북 참새 #33", symbol: "NVDA",
    content: "한장으로 안 묶습니다. 내부자 매도는 임원·이사가 자기 회사 주식을 파는 공시입니다. 9월 2일 184만 8,501주를 주당 222.26달러, 9월 4일 102만 2,239주를 주당 230.51달러에 팔았고 합이 6억 달러를 넘습니다. 종가는 223.67달러(−0.91%)였습니다. 팔란티어 스택 발언과 다른 화면의 숫자입니다. 다음 확인할 것은 추가 공시입니다.",
    likes: 16, comments: 2, created_at: "2026-09-11T01:48:00.000Z", liked: false,
  },
  {
    id: -1206, alias: "노원 기러기 #21", symbol: "TSLA",
    content: "정의부터 확인합니다. 블랙록은 세계 큰 자산운용사입니다. 2분기 공시에 테슬라 보통주 600만 주 매수가 찍혔습니다. 이미 지난 분기 스냅샷입니다. 유타 7대·사이버캡 스펙과 다른 화면의 숫자입니다. 다음 확인할 것은 다음 13F입니다.",
    likes: 17, comments: 1, created_at: "2026-09-11T01:54:00.000Z", liked: false,
  },
  {
    id: -1207, alias: "종로 까치 #41", symbol: "SPCX",
    content: "표에 숫자만 남깁니다. 궤도 컴퓨팅은 지상 데이터센터 대신 위성에서 연산을 돌리는 그림입니다. 재무담당이 내년에 첫 위성을 올리겠다고 했습니다. 시제·실증 단계입니다. 스타십 매출 비행·데이터센터 재설계와 다른 화면의 숫자입니다. 다음 확인할 것은 발사 매니페스트입니다.",
