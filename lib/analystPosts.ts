...
export const MOCK_ANALYST_POSTS: AnalystMockPost[] = [
  // ── 2026-07-16 신규 ──────────────────────────────────────────────────────
  {
    ...
    symbol: "TSLA",
    content:
      "TSLA 유럽 채널 체크해봤는데 FSD 롤아웃이 핵심이야. 1) 2026.21.100(v14.2.2.6) 유럽 3차 배치 시작. 2) 2026.20+ 브랜치 최신기능. 3) Supervised — 완전자율 아님, 개입 준비 필수. 4) 배치 확대 속도가 국가 확장 신호. 5) 투자: 구독매출 스토리 강화, 규제속도 트래킹. BUY(누적).",
    likes: 2181,
    comments: 3,
  ...
  },
  {
    ...
    symbol: "TSLA",
    content:
      "Optimus 캐파 발언이 오늘 핵심이야. 이유는 스케일 자체가 다르니까. 1) 프리몬트 100만대. 2) 기가텍사스 1000만대. 3) 실현시 자동차 규모 휴머노이드 산업화 최초. 4) 아직 목표치, 착공 확인 필요. 5) 투자: 로보틱스 밸류 프레임 촉매, 시차 리스크 감안. BUY(장기, 사이즈 조절).",
    likes: 2184,
    comments: 4,
  ...
  },
  {
    ...
    symbol: "BRK.B",
    content:
      "버핏 발언 다시 뜯어봤는데 톤이 방어적이야. 1) Fed 2%도 과함, 제로가 이상적. 2) 2%로도 물가 35년마다 2배. 3) \"도박하듯 투자할 때 가치 찾기 어렵다\". 4) 밸류에이션 부담 우회적 경고로 해석. 5) 투자: 현금 실질수익률 재점검, 신규 진입 보수적. NEUTRAL(관망).",
    likes: 2187,
    comments: 5,
  ...
  },
  {
    ...
    symbol: "TSLA",
    content:
      "KBB 결과랑 딱 맞아 떨어져서 마진 개선 시그널로 본다. 1) 6월 평균가 -2.1% YoY(최소 하락). 2) EV 시장 전체 -4.5%, 훨씬 큰 하락. 3) Model Y $51,775, 업계 평균보다 낮음. 4) 그러면서도 EV 판매 35%+ 점유. 5) 투자: 다음 분기 GM ex-credits 개선 체크. BUY.",
    likes: 2190,
    comments: 3,
  ...
  },
  {
    ...
    symbol: "NVDA",
    content:
      "NVDA 서플라이체인 채널 체크해봤는데 CEO 반박이 빨랐어. 1) 젠슨 황, Vera Rubin 지연설 직접 부인. 2) \"이미 생산 중\". 3) 대량 하드웨어 입고, 램프업 준비. 4) 매출인식 시점은 별개로 확인 필요. 5) 투자: 다음 실적 가이던스에서 매출 가시성 확인. BUY(추적관망).",
    likes: 2193,
    comments: 4,
  ...
  },
  {
    ...
    symbol: "TSLA",
    content:
      "로보택시 텍사스 숫자 보고 한 가지가 눈에 들어왔어. 1) 모델Y 1대당 연 $700만+ 수익 가능. 2) 생산비 $430만. 3) 사이버캡은 이 비용의 절반 미만. 4) 초기 단계에도 페이백 매력적. 5) 투자: 플릿 확장 속도·가동률이 다음 체크포인트. BUY.",
    likes: 2196,
    comments: 5,
  ...
  },
  {
    ...
    symbol: "TSLA",
    content:
      "Model Y 유럽 1위가 오늘 핵심이야. 이유는 가격전쟁 속 성장이라서. 1) YoY +68% 성장. 2) 5개월 76,760대. 3) 유럽 EV 판매 1위. 4) KBB 가격안정화와 동시 발생. 5) 투자: 지역 다변화·매출마진 동반개선 기대. BUY.",
    likes: 2199,
    comments: 3,
  ...
  },
  {
    ...
    symbol: "EQIX",
    content:
      "EQIX 매입 공시가 오늘 핵심이야. 이유는 상징성 때문. 1) 트럼프: 데이터센터가 미래 일자리 최대 동력. 2) EQIX 최대 $100만 매입 신고. 3) 주가 $1,022.60(-0.09%), 반응은 미미. 4) 정책신호로 해석 가능하나 확정 아님. 5) 투자: 데이터센터 리츠·전력 인프라 관심 환기, 정책 확인 필요. NEUTRAL.",
    likes: 2202,
    comments: 4,
  ...
  },
  {
    ...
    symbol: "AAPL",
    content:
      "AAPL 반도체 채널 체크해봤는데 생각보다 급해 보여. 1) AI칩 인수 위해 은행·스타트업 접촉. 2) 자체 M2 울트라 서버, 고급 워크로드 한계. 3) 구글클라우드 내 Nvidia 의존. 4) 차세대칩 Baltra 지연. 5) 투자: 온디바이스 AI 고도화 지연 리스크, M&A 발표 트리거 주시. NEUTRAL(의문).",
    likes: 2205,
    comments: 5,
  ...
  },
  {
    ...
    symbol: "SPCX",
    content:
      "SPCX 숫자 보고 한 가지가 눈에 들어왔어. 1) IPO가 $135 하회, $133.18. 2) 일중 +17.25% 반등. 3) YTD -27.77%. 4) 초기 투자자 상당수 손실구간. 5) 투자: 변동성 확대 국면, 방향성 확정은 이르다. NEUTRAL(관망).",
    likes: 2208,
    comments: 3,
  ...
  },
  {
    ...
    symbol: "ASML",
    content:
      "ASML 실적이 오늘 핵심이야. 이유는 가이던스 폭이 크다서. 1) 매출 €9.33B, EPS €7.59 모두 상회. 2) FY26 가이던스 €36-40B→€43-45B. 3) 2027까지 EUV·DUV 캐파 30% 확대. 4) 머스크와 TeraFab 협업 발표. 5) 투자: AI 반도체 공급망 전체 우호적, 협업 디테일 후속 확인. BUY.",
    likes: 2211,
    comments: 4,
  ...
  },
  {
    ...
    symbol: "SPY",
    content:
      "BofA 서베이 결과랑 딱 맞아 떨어져서 경계 신호로 본다. 1) 현금비중 4.1%→3.6%. 2) 이번 세기 최저권. 3) 매도 신호(Sell Signal) 발동. 4) 역발상 지표, 즉각 매도신호는 아님. 5) 투자: 헤지 비중 점검, 밸류에이션 지표 병행 확인. NEUTRAL(주의).",
    likes: 2214,
    comments: 5,
  ...
  },
  {
    ...
    symbol: "TSLA",
    content:
      "대륙횡단 주행 클립 봤는데, 완성도가 예상보다 높아. 1) V14 Lite, AI3로 5,135마일 완주. 2) 대형 안전 이슈 없음. 3) \"더 많은 고객에게 확대해야\" 목소리 확산. 4) 커뮤니티 테스트, 공식 검증 아님. 5) 투자: 배포확대 공식발표·개입빈도 데이터 확인 필요. BUY(잠정).",
    likes: 2217,
    comments: 3,
  ...
  },
  {
    ...
    symbol: "TSLA",
    content:
      "EV 오너 설문 보고 한 가지가 눈에 들어왔어. 1) 가솔린 복귀 의향 단 0.5%. 2) EV 유지 의향 99.5%. 3) 초기 충전불안 우려, 실제 이탈로 안 이어짐. 4) 표본·방법론 디테일 제한적. 5) 투자: 장기 수요기반 견조 근거로 보조 활용. BUY(보조지표).",
    likes: 2220,
    comments: 4,
  ...
  },
  {
    ...
    symbol: "GOOGL",
    content:
      "CNBC 발언 결과랑 딱 맞아 떨어져서 스토리가 확인됐어. 1) 버핏, 구글 투자 직접 주도 확인. 2) $15.4B 지분 공개 후 +34%. 3) 현재 $371.81. 4) 가치투자 관점에서도 매력 평가. 5) 투자: 이미 상승 반영, 밸류에이션·실적 지속성 확인 후 진입. NEUTRAL(밸류체크).",
    likes: 2223,
    comments: 5,
  ...
  },
  {
    ...
    symbol: "AAPL",
    content:
      "중국 채널 체크해봤는데 AAPL AI 락 풀린 게 크네. 1) 온디바이스 AI 중국 승인. 2) 알리바바 Qwen, iOS·iPadOS·macOS·visionOS 통합. 3) 로컬 파트너십으로 규제 장벽 해소. 4) 알리바바 클라우드·AI 사업에도 우호적. 5) 투자: 중국 판매·업그레이드 수요 촉매, 출시일정·기능범위 확인. BUY.",
    likes: 2226,
    comments: 3,
...
export const MOCK_ANALYST_COMMENTS: Record<number, AnalystMockComment[]> = {
  // ── 2026-07-16 신규 ──────────────────────────────────────────────────────
  [-327]: [
    { alias: "여의도 수리부엉이 #12", content: "TSLA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:05:02.000Z" },
    { alias: "강남 독수리 #23", content: "TSLA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:05:04.000Z" },
    { alias: "서초 매 #34", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:05:06.000Z" }
  ],
  [-328]: [
    { alias: "을지로 황소 #45", content: "TSLA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:12:02.000Z" },
    { alias: "광화문 표범 #56", content: "TSLA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:12:04.000Z" },
    { alias: "마포 콘도르 #67", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:12:06.000Z" },
    { alias: "판교 사자 #78", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T00:12:08.000Z" }
  ],
  [-329]: [
    { alias: "잠실 호랑이 #89", content: "BRK.B 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:19:02.000Z" },
    { alias: "역삼 팔콘 #01", content: "BRK.B 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:19:04.000Z" },
    { alias: "청담 올빼미 #12", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:19:06.000Z" },
    { alias: "압구정 여우 #23", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T00:19:08.000Z" },
    { alias: "삼성동 곰 #34", content: "모멘텀만 추격하기보다 리스크 예산부터.", created_at: "2026-07-16T00:19:10.000Z" }
  ],
  [-330]: [
    { alias: "논현 늑대 #45", content: "TSLA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:26:02.000Z" },
    { alias: "이촌 수리부엉이 #56", content: "TSLA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:26:04.000Z" },
    { alias: "성수 독수리 #67", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:26:06.000Z" }
  ],
  [-331]: [
    { alias: "한남 매 #78", content: "NVDA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:33:02.000Z" },
    { alias: "송파 황소 #89", content: "NVDA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:33:04.000Z" },
    { alias: "분당 표범 #01", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:33:06.000Z" },
    { alias: "목동 콘도르 #12", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T00:33:08.000Z" }
  ],
  [-332]: [
    { alias: "신촌 사자 #23", content: "TSLA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:40:02.000Z" },
    { alias: "여의도 호랑이 #34", content: "TSLA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:40:04.000Z" },
    { alias: "강남 팔콘 #45", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:40:06.000Z" },
    { alias: "서초 올빼미 #56", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T00:40:08.000Z" },
    { alias: "을지로 여우 #67", content: "모멘텀만 추격하기보다 리스크 예산부터.", created_at: "2026-07-16T00:40:10.000Z" }
  ],
  [-333]: [
    { alias: "광화문 곰 #78", content: "TSLA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:47:02.000Z" },
    { alias: "마포 늑대 #89", content: "TSLA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:47:04.000Z" },
    { alias: "판교 수리부엉이 #01", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:47:06.000Z" }
  ],
  [-334]: [
    { alias: "잠실 독수리 #12", content: "EQIX 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T00:54:02.000Z" },
    { alias: "역삼 매 #23", content: "EQIX 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T00:54:04.000Z" },
    { alias: "청담 황소 #34", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T00:54:06.000Z" },
    { alias: "압구정 표범 #45", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T00:54:08.000Z" }
  ],
  [-335]: [
    { alias: "삼성동 콘도르 #56", content: "AAPL 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:01:02.000Z" },
    { alias: "논현 사자 #67", content: "AAPL 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:01:04.000Z" },
    { alias: "이촌 호랑이 #78", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:01:06.000Z" },
    { alias: "성수 팔콘 #89", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T01:01:08.000Z" },
    { alias: "한남 올빼미 #01", content: "모멘텀만 추격하기보다 리스크 예산부터.", created_at: "2026-07-16T01:01:10.000Z" }
  ],
  [-336]: [
    { alias: "송파 여우 #12", content: "SPCX 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:08:02.000Z" },
    { alias: "분당 곰 #23", content: "SPCX 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:08:04.000Z" },
    { alias: "목동 늑대 #34", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:08:06.000Z" }
  ],
  [-337]: [
    { alias: "신촌 수리부엉이 #45", content: "ASML 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:15:02.000Z" },
    { alias: "여의도 독수리 #56", content: "ASML 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:15:04.000Z" },
    { alias: "강남 매 #67", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:15:06.000Z" },
    { alias: "서초 황소 #78", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T01:15:08.000Z" }
  ],
  [-338]: [
    { alias: "을지로 표범 #89", content: "SPY 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:22:02.000Z" },
    { alias: "광화문 콘도르 #01", content: "SPY 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:22:04.000Z" },
    { alias: "마포 사자 #12", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:22:06.000Z" },
    { alias: "판교 호랑이 #23", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T01:22:08.000Z" },
    { alias: "잠실 팔콘 #34", content: "모멘텀만 추격하기보다 리스크 예산부터.", created_at: "2026-07-16T01:22:10.000Z" }
  ],
  [-339]: [
    { alias: "역삼 올빼미 #45", content: "TSLA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:29:02.000Z" },
    { alias: "청담 여우 #56", content: "TSLA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:29:04.000Z" },
    { alias: "압구정 곰 #67", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:29:06.000Z" }
  ],
  [-340]: [
    { alias: "삼성동 늑대 #78", content: "TSLA 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:36:02.000Z" },
    { alias: "논현 수리부엉이 #89", content: "TSLA 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:36:04.000Z" },
    { alias: "이촌 독수리 #01", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:36:06.000Z" },
    { alias: "성수 매 #12", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T01:36:08.000Z" }
  ],
  [-341]: [
    { alias: "한남 황소 #23", content: "GOOGL 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:43:02.000Z" },
    { alias: "송파 표범 #34", content: "GOOGL 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:43:04.000Z" },
    { alias: "분당 콘도르 #45", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:43:06.000Z" },
    { alias: "목동 사자 #56", content: "사이즈·타임호라이즌 먼저 정하고 해석하자.", created_at: "2026-07-16T01:43:08.000Z" },
    { alias: "신촌 호랑이 #67", content: "모멘텀만 추격하기보다 리스크 예산부터.", created_at: "2026-07-16T01:43:10.000Z" }
  ],
  [-342]: [
    { alias: "여의도 팔콘 #78", content: "AAPL 숫자만으로도 포지션 점검 값이야.", created_at: "2026-07-16T01:50:02.000Z" },
    { alias: "강남 올빼미 #89", content: "AAPL 쪽으로는 오늘 흐름에서 무시하기 어려운 이벤트.", created_at: "2026-07-16T01:50:04.000Z" },
    { alias: "서초 여우 #01", content: "시사점은 펀더멘털과 내러티브를 분리하는 것.", created_at: "2026-07-16T01:50:06.000Z" }
  ],
  // ── 2026-07-15 신규 ──────────────────────────────────────────────────────
  [-293]: [
