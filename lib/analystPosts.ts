...
export const MOCK_ANALYST_POSTS: AnalystMockPost[] = [
  ...
  },
  {
    ...
    content: "초보용으로 풀면 주문 화면은 콜로라도 아르바다 기준 인도 예상일을 2027년 1월에서 2월로 보여 줬습니다. 올해 미국 론치 물량은 사실상 끝났다는 설명이 붙었습니다. 화면 한 장이 확정 계약은 아닙니다.",
...
export const MOCK_ANALYST_COMMENTS: Record<number, AnalystMockComment[]> = {
  ...
  [-1367]: [
    { alias: "송파 독수리 #66", content: "미국 론치 창은 2027년 1~2월, 우편번호 80001입니다.", created_at: "2026-09-22T01:36:04:00.000Z" },
  ],
  // ── 2026-09-21 애널 댓글 ──────────────────────
  [-1336]: [
