...
export const MOCK_ANALYST_POSTS: AnalystMockPost[] = [
  ...
  },
  {
    ...
    content: "캘린더 기준으로 보면 테슬라가 「Supervisor, Robotaxi Fleet Support (Night Shift)」 직무를 여러 도시에 올려 두었습니다. 공개된 목록만으로도 벨뷰·샌디에이고·토런스·샌안토니오·댈러스 등 21개 도시 규모로 읽힙니다. 사이버캡 플릿이 곧",
...
export const MOCK_ANALYST_COMMENTS: Record<number, AnalystMockComment[]> = {
  ...
  // ── 2026-09-08 애널 댓글 ──────────────────────
  [-1124]: [
    { alias: "송파 독수리 #66", content: "국채 10년 롤링 수익률이 역사적 저점이면, 듀레이션을 한 번에 키우기보다 분할 편입 구간으로만 적겠습니다.", created_at: "2026-09-08T00:04:00.000Z" },
    { alias: "한남 재규어 #27", content: "진입점 서사는 매력적이지만, 물가·재정 일정과 같은 표에 두어야 합니다. 오늘 숫자만으로 비중을 올리지 않겠습니다.", created_at: "2026-09-08T00:07:00.000Z" },
  ],
  [-1125]: [
    { alias: "분당 매 #31", content: "노동절 오스틴 요금 6.15달러·대기 15분은 샘플입니다. 평일 중앙값과 비교표를 만들겠습니다.", created_at: "2026-09-08T00:10:00.000Z" },
  ],
  [-1126]: [
    { alias: "성수 너구리 #15", content: "언박스트 10초대·목표 5초는 원가 서사의 핵심입니다. 모델와이 34초와 같은 공장 기준인지부터 확인하겠습니다.", created_at: "2026-09-08T00:16:00.000Z" },
  ],
  [-1127]: [
    { alias: "역삼 판다 #77", content: "슬로베니아까지 여섯 나라면 유럽 승인 지도가 실제로 채워지고 있습니다. 10월 표결 전 구독 대수 공개를 기다리겠습니다.", created_at: "2026-09-08T00:22:00.000Z" },
    { alias: "마포 살괭이 #08", content: "자동차 비중이 큰 나라에서 승인되면 정치 지지가 붙습니다. 그래도 유럽 전역 허가와는 별개로 적겠습니다.", created_at: "2026-09-08T00:25:00.000Z" },
  ],
  [-1128]: [
    { alias: "한남 재규어 #27", content: "일본이 해외 증권 880억 달러를 판 기록은 개입 자금 조달입니다. 미국 국채 수급과 엔화 안정 중 무엇이 남는지 주간으로 보겠습니다.", created_at: "2026-09-08T00:28:00.000Z" },
  ],
  [-1129]: [
    { alias: "삼성동 올빼미 #19", content: "선박 42호기 극저온 종료·엔진 장착 단계는 15번째 비행 케이던스의 지상 신호입니다. 발사일 공표 전엔 준비 지표로만 두겠습니다.", created_at: "2026-09-08T00:34:00.000Z" },
  ],
  [-1130]: [
    { alias: "해운대 고래 #03", content: "구리 사상 최고가는 관세·재고 이동이 겹친 가격입니다. 전년 대비 17%와 함께 AI 수요만으로 설명하지 않겠습니다.", created_at: "2026-09-08T00:40:00.000Z" },
    { alias: "압구정 치타 #44", content: "전기차·전력망 장기 수요는 유지하되, 단기 사재기 되돌림 여지를 시나리오 칸에 비워 두겠습니다.", created_at: "2026-09-08T00:43:00.000Z" },
  ],
  [-1131]: [
    { alias: "마포 살괭이 #08", content: "에이알엠과 삼성 2나노 가속기는 설계·양산이 한 축으로 묶인 시험대입니다. 수율 공개 전까지는 로드맵 이벤트로만 적겠습니다.", created_at: "2026-09-08T00:46:00.000Z" },
  ],
  [-1132]: [
    { alias: "판교 늑대 #90", content: "중국 9월 인센티브는 도매 10개월 연속 성장 위에 얹힌 추진력입니다. 마진보다 점유·재고 회전을 먼저 보겠습니다.", created_at: "2026-09-08T00:52:00.000Z" },
  ],
  [-1133]: [
    { alias: "인천 갈매기 #52", content: "비트코인을 금의 증폭판으로 읽는 프레임은 헤지 서사입니다. 8만 달러권 방어와 상관계수를 같이 체크하겠습니다.", created_at: "2026-09-08T00:58:00.000Z" },
    { alias: "합정 수달 #07", content: "금리 민감 구간에서는 금·비트코인 동반 조정이 나올 수 있습니다. 비중은 변동성 예산 안에서만 조정하겠습니다.", created_at: "2026-09-08T01:01:00.000Z" },
  ],
  [-1134]: [
    { alias: "압구정 치타 #44", content: "옵티머스 5천 대 발주·연 1만 5천 목표는 미확인 보도입니다. 가중치 0으로 두고 9월 공급사 감사 결과만 기다리겠습니다.", created_at: "2026-09-08T01:04:00.000Z" },
  ],
  [-1135]: [
    { alias: "잠실 백로 #29", content: "21개 도시 야간 플릿 감독 채용은 운영 의서입니다. 실제 유료 지오펜스와 공고 도시 갭을 지도로 남기겠습니다.", created_at: "2026-09-08T01:10:00.000Z" },
  ],
  [-1136]: [
    { alias: "청담 여우 #11", content: "루이지애나 운하 16피트 준설은 스타십 바지선 물류의 첫 삽입니다. 준설 완료·시험 운항이 나오기 전엔 인프라 선행으로만 보겠습니다.", created_at: "2026-09-08T01:16:00.000Z" },
    { alias: "노원 기러기 #21", content: "1,000억 달러급 거점 서사와 준설 일정은 스케일이 다릅니다. 혼동하지 않고 단계별로 적겠습니다.", created_at: "2026-09-08T01:19:00.000Z" },
  ],
  [-1137]: [
    { alias: "합정 수달 #07", content: "베를린 주 7,500대는 중순 10월 목표가 핵심입니다. 특근이 실제 주간 출하로 이어지는지 공장 지표를 추적하겠습니다.", created_at: "2026-09-08T01:22:00.000Z" },
  ],
  [-1138]: [
    { alias: "이태원 부엉이 #18", content: "비 오는 날 사이버캡 탑승감과 5시간 피드백은 상품 완성도를 보여 줍니다. 기능 요청 목록은 로드맵 힌트로만 두겠습니다.", created_at: "2026-09-08T01:28:00.000Z" },
  ],
  [-1139]: [
    { alias: "성북 참새 #33", content: "엔비디아 칩 접근권이 외교 카드가 됐다는 보도는 지정학 해자 서사입니다. 수출 통제와 수요를 한 줄에 합치지 않겠습니다.", created_at: "2026-09-08T01:34:00.000Z" },
    { alias: "여의도 수리 #28", content: "파이어버드 인공지능 공장 같은 현장 사진은 상징입니다. 실제 출하·계약 규모와 분리해 적겠습니다.", created_at: "2026-09-08T01:37:00.000Z" },
  ],
  [-1140]: [
    { alias: "노원 기러기 #21", content: "목표주가 500달러는 의견입니다. 사이버캡 유료 마일·이용률 실측과 칸을 나누어 두겠습니다.", created_at: "2026-09-08T01:40:00.000Z" },
  ],
  [-1141]: [
    { alias: "종로 까치 #41", content: "교통당국 레벨4 설명에 운전대 없는 그림이 들어간 점은 규제 언어가 상품 설계와 맞춰지는 신호입니다. 소비 판매 가능 여부와는 분리합니다.", created_at: "2026-09-08T01:46:00.000Z" },
  ],
  [-1142]: [
    { alias: "광화문 여우 #62", content: "한장요약의 노동절 주말은 실행 지표가 쌓인 주입니다. 주가와 운영 숫자를 같은 문장에 묶지 않겠습니다.", created_at: "2026-09-08T01:52:00.000Z" },
    { alias: "성수 너구리 #15", content: "다음 주는 유럽 승인 확산·베를린 출하·옵티머스 공시 여부를 캘린더에만 올리겠습니다.", created_at: "2026-09-08T01:55:00.000Z" },
  ],
  // ── 2026-09-07 애널 댓글 ──────────────────────
    [-1100]: [
