...
export const MOCK_ANALYST_POSTS: AnalystMockPost[] = [
  ...
  },
  {
    ...
    content: "핵심만 정리합니다. 로보택시 앱 화면에 사이버캡 2인승과 모델와이 4인승이 함께 떴고 요금은 4.20달러입니다. 다음 확인은 공식 숫자입니다.",
...
export const MOCK_ANALYST_COMMENTS: Record<number, AnalystMockComment[]> = {
  ...
  // ── 2026-09-04 애널 댓글 ──────────────────────
  [-1007]: [
    { alias: "송파 독수리 #66", content: "한장요약 seed-1476 메모입니다. 9월 3일 밤에 열린 오스틴 사이버캡 행사 다음 날입니다. 테슬라 주가는 376.37달 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:03:00.000Z" },
  ],
  [-1008]: [
    { alias: "분당 매 #31", content: "테슬라 seed-1477 메모입니다. 9월 3일 텍사스 오스틴에서 사이버캡 전용 행사가 미 동부 오후 5시 45분에 열렸습니 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:10:00.000Z" },
  ],
  [-1009]: [
    { alias: "성수 너구리 #15", content: "테슬라 seed-1478 메모입니다. 로보택시 앱 화면에 사이버캡 2인승과 모델와이 4인승이 함께 떴고 요금은 4.20달러였 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:17:00.000Z" },
  ],
  [-1010]: [
    { alias: "역삼 판다 #77", content: "테슬라 seed-1479 메모입니다. 사이버캡 배터리는 48킬로와트시, 주행거리 약 470킬로미터, 전비 165와트시/마일( 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:24:00.000Z" },
    { alias: "마포 살쾡이 #08", content: "seed-1479 후속입니다. 사이버캡 전비가 마일당 165와트시로 루시드·모델3보다 약 쪽은 다음 주 표에 반영하겠습니다.", created_at: "2026-09-04T00:26:00.000Z" },
  ],
  [-1011]: [
    { alias: "한남 재규어 #27", content: "테슬라 seed-1480 메모입니다. 운용 원가 마일당 약 20센트, 세금 포함 시 30~40센트로 버스 약 1달러/마일보다 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:31:00.000Z" },
  ],
  [-1012]: [
    { alias: "삼성동 올빼미 #19", content: "테슬라 seed-1481 메모입니다. 2025년 말 오스틴 본사·제조 인력은 1만 6,506명이었습니다. 2028년 목표 3 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:38:00.000Z" },
  ],
  [-1013]: [
    { alias: "해운대 고래 #03", content: "테슬라 seed-1482 메모입니다. 텍사스 로보택시 420대 중 감독자 없이 운행할 수 있는 인가는 45대입니다. 무인 유 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:45:00.000Z" },
    { alias: "압구정 치타 #44", content: "seed-1482 후속입니다. 텍사스 로보택시 420대 가운데 무인 인가 차량은 45대로 쪽은 다음 주 표에 반영하겠습니다.", created_at: "2026-09-04T00:47:00.000Z" },
  ],
  [-1014]: [
    { alias: "마포 살쾡이 #08", content: "테슬라 seed-1483 메모입니다. 한국수입자동차협회 집계로 테슬라 8월 판매는 1만 400대, 전년 대비 30.4% 증가 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:52:00.000Z" },
  ],
  [-1015]: [
    { alias: "판교 늑대 #90", content: "테슬라 seed-1484 메모입니다. 호주 판매가 전년 대비 160% 늘었다는 집계가 한국 8월 1만 400대와 같은 주에  이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T00:59:00.000Z" },
  ],
  [-1016]: [
    { alias: "인천 갈매기 #52", content: "우버 seed-1485 메모입니다. 런던에서 우버와 웨이브의 자율주행 승차가 광역으로 열렸다고 소개됐습니다. 운전석에는 아 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:06:00.000Z" },
    { alias: "합정 수달 #07", content: "seed-1485 후속입니다. 우버와 웨이브가 런던에서 넓은 자율주행 서비스를 시작했고  쪽은 다음 주 표에 반영하겠습니다.", created_at: "2026-09-04T01:08:00.000Z" },
  ],
  [-1017]: [
    { alias: "압구정 치타 #44", content: "우버 seed-1486 메모입니다. 우버가 택시기사 단체와 로보택시 확대를 늦추는 쪽에 서 있다는 보도가 나왔습니다. 같은 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:13:00.000Z" },
  ],
  [-1018]: [
    { alias: "잠실 백로 #29", content: "엔비디아 seed-1487 메모입니다. 9월 2일 공시에 따르면 주주에게 119억 달러, 잔류 보상 최대 10억 달러로 합쳐  이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:20:00.000Z" },
  ],
  [-1019]: [
    { alias: "청담 여우 #11", content: "스페이스X seed-1488 메모입니다. 비상장 호가가 약 150달러로 7.5~7.6% 올랐고 시가총액 2조 달러 서사가 퍼졌습 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:27:00.000Z" },
    { alias: "노원 기러기 #21", content: "seed-1488 후속입니다. 스페이스X 비상장 호가가 약 150달러로 7.5% 올랐고  쪽은 다음 주 표에 반영하겠습니다.", created_at: "2026-09-04T01:29:00.000Z" },
  ],
  [-1020]: [
    { alias: "합정 수달 #07", content: "스페이스X seed-1489 메모입니다. 현재 1.4기가와트는 1년 전 400메가와트에서 늘어난 숫자입니다. 연말 2기가와트 이 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:34:00.000Z" },
  ],
  [-1021]: [
    { alias: "이태원 부엉이 #18", content: "스페이스X seed-1490 메모입니다. 추가 830에이커는 니켈 초합금 터빈 블레이드·베인 주조 공장으로 거론됐습니다. 에이커 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:41:00.000Z" },
  ],
  [-1022]: [
    { alias: "성북 참새 #33", content: "스페이스X seed-1491 메모입니다. 툴레인 로드 토지 교환, 51에이커, 60만 평방피트 건물입니다. 멤피스·북미시시피 다 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:48:00.000Z" },
    { alias: "강남 표범 #04", content: "seed-1491 후속입니다. 스페이스엑스에이아이 데이터센터가 사우스헤이븐 60만 평방피 쪽은 다음 주 표에 반영하겠습니다.", created_at: "2026-09-04T01:50:00.000Z" },
  ],
  [-1023]: [
    { alias: "노원 기러기 #21", content: "스페이스X seed-1492 메모입니다. 멤피스 스타링크 가입은 6월 말 이후 약 2,000건이고 주거 요금은 50% 할인입니다 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T01:55:00.000Z" },
  ],
  [-1024]: [
    { alias: "분당 호랑이 #55", content: "인공지능 seed-1493 메모입니다. 성장 속도 발언과 이비티다 흑자 소문, 예측시장에서 12월 31일까지 앤스로픽 가치가  이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T02:02:00.000Z" },
  ],
  [-1025]: [
    { alias: "여의도 학 #12", content: "인공지능 seed-1494 메모입니다. 아스트라는 새 모델 계열 이름입니다. 사이버 가드레일은 해킹·악용 지시를 거르는 필터입 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T02:09:00.000Z" },
    { alias: "광화문 여우 #62", content: "seed-1494 후속입니다. 오픈에이아이가 지피티6 아스트라를 배포하며 사이버 가드레일 쪽은 다음 주 표에 반영하겠습니다.", created_at: "2026-09-04T02:11:00.000Z" },
  ],
  [-1026]: [
    { alias: "강남 표범 #04", content: "구글 seed-1495 메모입니다. 에이블은 약 15개월 전 180~190달러에 구글 매수를 시작했다고 설명했습니다. 10 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T02:16:00.000Z" },
  ],
  [-1027]: [
    { alias: "마곡 펠리컨 #63", content: "금리 seed-1496 메모입니다. 2007년 5월 이후 가장 적은 비중입니다. 8월 31일 기준 10년물은 4.41%였고 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T02:23:00.000Z" },
  ],
  [-1028]: [
    { alias: "종로 까치 #41", content: "스페이스X seed-1497 메모입니다. 제안요청서 규모 약 100억 달러, 36개월, 스타베이스 루이지애나 입지가 떠돌았습니다 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T02:30:00.000Z" },
    { alias: "분당 매 #31", content: "seed-1497 후속입니다. 루이지애나 스타베이스에 약 100억 달러 메탄 설비 제안이 쪽은 다음 주 표에 반영하겠습니다.", created_at: "2026-09-04T02:32:00.000Z" },
  ],
  [-1029]: [
    { alias: "광화문 여우 #62", content: "스페이스X seed-1498 메모입니다. 머스크가 달 인공지능 위성과 100테라와트, 질량 가속기, 탈출 속도 초속 약 2,40 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T02:37:00.000Z" },
  ],
  [-1030]: [
    { alias: "여의도 수리 #28", content: "스페이스X seed-1499 메모입니다. 스타십 42호기가 극저온 시험을 시작했고 41호기와 비교되고 있습니다. 액체 산소·메탄 이 줄만 따로 적어두겠습니다.", created_at: "2026-09-04T02:44:00.000Z" },
  ],
  // ── 2026-09-03 애널 댓글 ──────────────────────
  [-992]: [
