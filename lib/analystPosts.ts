...
export const MOCK_ANALYST_POSTS: AnalystMockPost[] = [
  ...
  },
  {
    ...
    likes: 512,
    comments: 3,
    created_at: "2026-06-24T09:08:00.000Z",
    liked: false,
  },
  {
    id: -146,
  ...
  },
  {
    ...
    likes: 467,
    comments: 2,
    created_at: "2026-06-24T08:54:00.000Z",
    liked: false,
  },
  {
    id: -148,
    ...
    likes: 531,
    comments: 3,
    created_at: "2026-06-24T08:47:00.000Z",
    liked: false,
  },
  {
    id: -149,
    ...
    likes: 489,
    comments: 2,
    created_at: "2026-06-24T08:40:00.000Z",
    liked: false,
  },
  {
    id: -150,
    ...
    likes: 364,
    comments: 2,
    created_at: "2026-06-24T08:33:00.000Z",
    liked: false,
  },
  {
    id: -151,
  ...
  },
  {
    ...
    likes: 523,
    comments: 3,
    created_at: "2026-06-24T08:19:00.000Z",
    liked: false,
  },
  {
    id: -153,
  ...
  },
  {
    ...
    likes: 557,
    comments: 2,
    created_at: "2026-06-24T07:58:00.000Z",
    liked: false,
  },
  {
    id: -156,
    ...
    likes: 472,
    comments: 2,
    created_at: "2026-06-24T07:51:00.000Z",
    liked: false,
  },
  {
    id: -157,
    ...
    likes: 508,
    comments: 3,
    created_at: "2026-06-24T07:44:00.000Z",
    liked: false,
  },
...
export const MOCK_ANALYST_COMMENTS: Record<number, AnalystMockComment[]> = {
  // ── 2026-06-24 신규 ──────────────────────────────────────────────────────
  [-144]: [
    { alias: "잠실 황소 #39", content: "NTSB 보고서 주기가 평균 7~14일이야. 사고 뉴스 나오면 -2~3% 빠지고 보고서 나오면 원래대로 돌아오는 패턴 이미 7번 반복됐어. 이걸 시스템으로 만들면 수익화 가능한 트레이딩 패턴이야.", created_at: "2026-06-24T09:11:00.000Z" },
    { alias: "구리 독수리 #67", content: "미디어 바이어스 지수에서 TSLA 관련 사고 보도가 타 EV 대비 5.7배 더 많이 나오는 게 측정됐어. 언론 관심도 비대칭이 주가 왜곡을 만드는 거야. 알고 쓰면 이게 알파야.", created_at: "2026-06-24T09:07:00.000Z" },
  ],
  [-145]: [
    { alias: "목동 팔콘 #52", content: "베를린 정상화가 핵심이야. Q1에 Model Y 신형 생산라인 셋업으로 4주간 조업 중단 있었는데 그게 Q1 볼륨 330K 원인이었어. Q2 베를린 풀 가동하면 유럽 볼륨 회복 확실해.", created_at: "2026-06-24T09:04:00.000Z" },
    { alias: "청담 황소 #31", content: "440K 발표되면 월가 어닝 추정이 즉시 상향돼. Q3·Q4 추정까지 도미노로 올라가거든. FY26 연간 추정 상향 → 목표주가 상향 → 기관 매수 순서야. 7월 첫째 주가 트리거야.", created_at: "2026-06-24T09:00:00.000Z" },
    { alias: "신촌 팔콘 #84", content: "Cybertruck 라인 → Model Y 전환이 볼륨 추가 원천이야. Cybertruck 월 1,500대 생산하던 라인이 Model Y 5,000대로 바뀐 거야. 이게 Texas 볼륨 상향 기여해.", created_at: "2026-06-24T08:56:00.000Z" },
  ],
  [-146]: [
    { alias: "상암 황소 #73", content: "EU 상호 인정 원칙 발동이 맞아. 3개국 이상 동시 승인 시 WP.29 규정에 따라 다른 EU 국가 자동 인정 절차 개시 가능해. 나머지 EU 국가들이 개별 심사 없이 수용할 수 있는 법적 근거가 생긴 거야.", created_at: "2026-06-24T08:57:00.000Z" },
    { alias: "구로 황소 #58", content: "유럽 FSD 구독 ARPU가 미국보다 높아. €199/월 vs $199/월인데 환율 고려하면 유럽이 +10~15% 높은 거야. 구독자 단가가 미국보다 유리한 시장이 열리는 거임.", created_at: "2026-06-24T08:53:00.000Z" },
  ],
  [-147]: [
    { alias: "압구정 황소 #62", content: "Neoen이 호주 최대 재생에너지 개발사야. 이 회사가 Tesla Megapack 독점 계약하면 향후 Neoen 프로젝트 전부가 Tesla ESS 수주 파이프라인이 되는 거야. 레퍼런스 효과가 엄청나.", created_at: "2026-06-24T08:50:00.000Z" },
    { alias: "한강 황소 #39", content: "ESS 사업 수주 잔고(backlog)가 몇 개월치라고 알려졌어. 이 계약까지 더해지면 2027년 말까지 생산 스케줄이 가득 차는 거야. 공급이 수요를 못 따라가는 구조야. 마진 방어 가능해.", created_at: "2026-06-24T08:46:00.000Z" },
  ],
  [-148]: [
    { alias: "여의도 독수리 #53", content: "BBB+ 첫 우주 채권 금리가 얼마로 결정되냐가 다음 발행의 기준이 돼. T+80bp 이하면 시장이 SpaceX를 A급으로 취급하는 거야. 수요 오더북 나오면 금리 타이트닝 거의 확실해.", created_at: "2026-06-24T08:43:00.000Z" },
    { alias: "도봉 황소 #76", content: "Colossus 2단계 400K H200으로 확장되면 Anthropic·Google 다음 계약 용량이 결정돼. AI 컴퓨팅 수요가 공급보다 빠르니까 확장 즉시 선점 계약 들어올 거야. AI 인프라 사업이 실적에 잡히기 시작해.", created_at: "2026-06-24T08:39:00.000Z" },
    { alias: "서울 황소 #23", content: "채권 $89B + 현금 $100B = SpaceX 유동성이 $189B이야. Apple 순현금 $60B의 3배야. 이 규모의 유동성으로 무엇을 인수할지가 다음 모멘텀이야. Cursor $80B 인수는 예고편이었던 거야.", created_at: "2026-06-24T08:35:00.000Z" },
  ],
  [-149]: [
    { alias: "강동 팔콘 #28", content: "Grok5를 Starlink 통해 차량에 클라우드 추론으로 제공하는 모델이 진짜 혁신이야. 온디바이스 한계를 클라우드+위성으로 극복하는 거야. 차량이 인터넷 끊겨도 Starlink 연결이면 10T 파라미터 AI 쓸 수 있는 거임.", created_at: "2026-06-24T08:36:00.000Z" },
    { alias: "송파 황소 #47", content: "Tesla Grok5 통합이 확정되면 xAI 기업가치가 올라가고 Elon의 두 회사 시너지가 숫자로 증명돼. TSLA 주주는 간접적으로 xAI 가치도 먹는 구조야. 생태계 통합 베팅이 맞아.", created_at: "2026-06-24T08:32:00.000Z" },
  ],
  [-150]: [
    { alias: "구로 팔콘 #44", content: "연준 동결 연장이 TSLA·SPCX엔 단기 부담이지만 장기론 다를 수 있어. 금리 높은 환경에서도 실적 성장 보여주면 오히려 '매크로 이겨내는 주식'으로 프리미엄 받거든. 실적 시즌 서프라이즈가 유일한 해답이야.", created_at: "2026-06-24T08:29:00.000Z" },
    { alias: "잠실 늑대 #51", content: "이란 유가 상승이 Tesla Energy 수요를 끌어올리는 역설이 흥미로워. 유가 $10 상승하면 재생에너지 ROI가 개선돼 ESS 투자가 늘거든. 단기 비용 부담보다 중기 수요 증가 효과가 더 커.", created_at: "2026-06-24T08:25:00.000Z" },
  ],
  [-151]: [
    { alias: "홍대 황소 #62", content: "DeepSeek API 사용 금지 리스크 맞아. 미국 정부가 중국 AI API 규제하면 Tesla가 Grok5로 전환해야 해. 그런데 이게 오히려 Grok5 통합을 앞당기는 트리거가 될 수 있어. 어느 쪽이든 FSD AI 업그레이드 방향이야.", created_at: "2026-06-24T08:22:00.000Z" },
    { alias: "연남 팔콘 #37", content: "비용 1/20 절감이 FSD 마진 개선으로 이어지는 로직이 맞아. 구독 매출 80% 마진에서 AI 추론 비용이 10% 하락하면 마진이 88%로 개선돼. 이게 EPS에 직접 반영되는 거야.", created_at: "2026-06-24T08:18:00.000Z" },
  ],
  [-152]: [
    { alias: "목동 황소 #83", content: "BOM $10K 이하 달성 로직이 정확해. 중국 하모닉 드라이브 단가가 미국산의 28%인데 이게 로봇 원가를 결정해. 중국 공급망 없이는 $20K 대중화 가격이 불가능해.", created_at: "2026-06-24T08:15:00.000Z" },
    { alias: "성수 팔콘 #49", content: "Foxconn이 Optimus 공급망에 들어온 게 중요한 신호야. Foxconn은 아이폰 10억 대 이상 생산한 정밀 제조 경험이 있어. Optimus 대량 생산이 현실화될 때 Foxconn 없이는 속도가 안 나와.", created_at: "2026-06-24T08:11:00.000Z" },
    { alias: "상암 팔콘 #58", content: "지정학 공급망 이원화 계획이 있는지가 중요해. Tesla가 말레이시아·인도·멕시코에 공급망 구축 검토 중이라는 얘기 있어. 중국 100% 의존 리스크 해소 로드맵이 있으면 투자자 불안 해소돼.", created_at: "2026-06-24T08:07:00.000Z" },
  ],
  [-153]: [
    { alias: "종로 황소 #72", content: "Starlink ARPU 가중 평균 $150 추정이 합리적이야. 기업·정부 고객이 믹스 개선하면 ARPU가 올라가. Direct-to-Cell은 볼륨을 늘리되 ARPU를 낮추는 트레이드오프인데 총매출 성장이 더 커.", created_at: "2026-06-24T08:08:00.000Z" },
    { alias: "강서 황소 #35", content: "통신사 비교하면 AT&T ARPU $55, Verizon $68인데 Starlink 글로벌 평균 $65~70 수준이면 가입자 규모로 글로벌 통신사 TOP 5 진입이야. 우주 기업이 통신사를 능가하는 거야.", created_at: "2026-06-24T08:04:00.000Z" },
  ],
  [-154]: [
    { alias: "압구정 늑대 #84", content: "국토부 ADAS 인증 절차가 6~12개월 걸려. 서버 이전 완료되면 인증 신청 가능하니까 빠르면 Q4 2026, 늦어도 Q1 2027 한국 FSD 출시야. 대기자 리스트 미리 만들어 놓을 만해.", created_at: "2026-06-24T08:01:00.000Z" },
    { alias: "신림 팔콘 #67", content: "PIPA 준수가 선결 조건이라는 해석이 맞아. 개인정보보호법 위반 시 매출의 3% 과징금이거든. Tesla가 한국 시장을 포기 안 하는 이상 서버 이전은 필수야. 이번 공지가 진지한 신호야.", created_at: "2026-06-24T07:57:00.000Z" },
    { alias: "합정 황소 #29", content: "한국 → 일본 도미노 맞아. 일본 국토교통성이 자율주행 레벨 3 승인 프레임워크를 이미 구축했어. Tesla가 한국에서 승인 전례 만들면 일본 심사가 훨씬 빨라져. 아시아 FSD 수익화 시작이야.", created_at: "2026-06-24T07:53:00.000Z" },
  ],
  [-155]: [
    { alias: "도봉 독수리 #41", content: "Tesla vs Waymo 학습 속도 비교가 핵심이야. Waymo는 하루 1만 5천 마일 실도로 + 수백만 마일 시뮬레이션. Tesla는 전 세계 차량 플릿에서 하루 수천만 마일 실도로 데이터. 이 비대칭이 역전을 만들어.", created_at: "2026-06-24T07:54:00.000Z" },
    { alias: "연희 팔콘 #63", content: "1,000만 마일/월 달성하면 로보택시 사업부 독립 공시 가능성이야. Tesla가 FSD·에너지·자동차 사업부를 분리 보고하기 시작하면 각 사업부 멀티플 합산이 지금 통합 시총보다 훨씬 커. Sum-of-parts 리레이팅이야.", created_at: "2026-06-24T07:50:00.000Z" },
  ],
  [-156]: [
    { alias: "구로 독수리 #77", content: "저궤도 냉각 우위가 진짜야. 우주는 복사 냉각으로 열 방출이 가능해. 지구 데이터센터 냉각 비용이 전체 운영비의 40%인데 우주에서 이게 줄어들면 비용 구조가 완전히 달라져.", created_at: "2026-06-24T07:47:00.000Z" },
    { alias: "강북 팔콘 #51", content: "Dragon XL 발사 비용이 Falcon 9 기준 $60M인데 Starship 기준 $10M으로 낮아지면 우주 데이터센터 경제성이 완전히 달라져. Starship 재사용 확립이 이 사업 현실화의 전제 조건이야.", created_at: "2026-06-24T07:43:00.000Z" },
  ],
  [-157]: [
    { alias: "성동 황소 #84", content: "ARK SPACE ETF AUM이 $2.1B인데 주간 $22M 순매수는 1%야. ARK가 한 주에 특정 종목에 1% 올인하는 경우 드물어. 내부에서 강한 상향 조정 이유가 있다는 뜻이야.", created_at: "2026-06-24T07:40:00.000Z" },
    { alias: "광진 황소 #46", content: "$168 지지선에서 ARK가 대량 매수하면 바닥 수급이 만들어지는 거야. IPO 따상 $200 → 조정 $168이 매수 기회라는 게 ARK가 증명하는 거임. 개인 투자자 매수 심리도 이 수급에 영향 받아.", created_at: "2026-06-24T07:36:00.000Z" },
    { alias: "망원 팔콘 #53", content: "Cathie Wood $300 목표 로드맵에서 가장 중요한 것이 Starlink IPO야. SpaceX 자회사로 Starlink 단독 상장하면 SPCX가 그 지분 보유로 재평가 받아. IPO 타임라인이 나오면 $300이 보수적인 숫자가 될 수 있어.", created_at: "2026-06-24T07:32:00.000Z" },
  ],
  // ── 2026-06-23 추가 (사이버캡·라스롭) ────────────────────────────────────
  [-143]: [
