...
export const MOCK_ANALYST_POSTS: AnalystMockPost[] = [
  ...
  },
  {
    ...
    symbol: "SNDK",
    content:
      "SNDK Leopold +780% 채널 체크해봤어 — 기관 공개가 신호였던 이유. 1) 2025년 11월 $250에 $53M 공개됐어. 지금 $2,225+이면 7개월에 +780%야. 연환산 1,340%야. 2) Leopold Altschermer 공개가 왜 신호였나: 기관이 이 규모 공개할 때는 목표가 확인 후야. 먼저 조용히 사고 공개하는 구조거든. 3) 신규 목표가 $2,500 상향 — AI NAND 수요 급증 반영. 현재가 대비 +12.4% 추가 업사이드. 4) 기관 공개 직후 진입 전략이 가장 수익률이 높은 이유가 이 패턴이야.",
    likes: 489,
    comments: 2,
