...
export const GURUS: Guru[] = [
  ...
  },
  {
    ...
    disclosureType: "13F",
    holdings: [
      { symbol: "BABA",  name: "Alibaba",          shares:  750, portfolioPct: 24.1 },
      { symbol: "JD",    name: "JD.com",           shares: 1820, portfolioPct: 19.3 },
      { symbol: "PDD",   name: "PDD Holdings",     shares:  430, portfolioPct: 17.2 },
      { symbol: "BIDU",  name: "Baidu",            shares:  660, portfolioPct: 14.8 },
      { symbol: "BKNG",  name: "Booking Holdings", shares:   28, portfolioPct:  8.4 },
      { symbol: "MGM",   name: "MGM Resorts",      shares: 2100, portfolioPct:  6.2 },
      { symbol: "WDC",   name: "Western Digital",  shares: 1040, portfolioPct:  5.1 },
      { symbol: "HCA",   name: "HCA Healthcare",   shares:  190, portfolioPct:  4.9 },
    ],
  },
  {
    id:             "druckenmiller",
