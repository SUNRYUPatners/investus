...
const _now = Date.now();
const T17J = _now;                        // 오늘(6/17) 포스트
const T16J = _now - 24 * 3600_000;       // 6/16
const T15J = _now - 48 * 3600_000;       // 6/15
const T13J = _now - 96 * 3600_000;       // 6/13
const T12J = _now - 120 * 3600_000;      // 6/12
const T11J = _now - 144 * 3600_000;      // 6/11
const T10J = _now - 168 * 3600_000;      // 6/10
export const LATEST_UPDATE = T17J;       // NEW 배지 기준
