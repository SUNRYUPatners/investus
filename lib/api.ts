...
const mockQuotes: Quote[] = [
  ...
  { symbol: "PLTR", name: "Palantir Technologies — 팔란티어",                  price: 120.0,  change: 2.4,  changePercent: 2.04, sparkline: [], volume: "60M",  marketCap: "280B" },
  { symbol: "RKLB", name: "Rocket Lab — 로켓랩",                               price: 28.0,   change: 0.6,  changePercent: 2.19, sparkline: [], volume: "18M",  marketCap: "13B"  },
  { symbol: "IONQ", name: "IonQ Inc. — 아이온큐 양자컴퓨팅",                   price: 38.0,   change: 1.2,  changePercent: 3.26, sparkline: [], volume: "12M",  marketCap: "8B"   },
  { symbol: "SNOW", name: "Snowflake — 스노우플레이크",                         price: 195.0,  change: 3.5,  changePercent: 1.83, sparkline: [], volume: "8M",   marketCap: "65B"  },
  { symbol: "NET",  name: "Cloudflare — 클라우드플레어",                        price: 135.0,  change: 2.1,  changePercent: 1.58, sparkline: [], volume: "7M",   marketCap: "46B"  },
  { symbol: "DDOG", name: "Datadog — 데이터독",                                 price: 155.0,  change: 2.8,  changePercent: 1.84, sparkline: [], volume: "5M",   marketCap: "50B"  },
  { symbol: "SHOP", name: "Shopify — 쇼피파이",                                 price: 115.0,  change: 1.5,  changePercent: 1.32, sparkline: [], volume: "10M",  marketCap: "145B" },
  { symbol: "SQ",   name: "Block Inc. — 블록 (스퀘어)",                         price: 70.0,   change: 1.0,  changePercent: 1.45, sparkline: [], volume: "8M",   marketCap: "43B"  },
  { symbol: "COIN", name: "Coinbase Global — 코인베이스",                       price: 280.0,  change: 6.0,  changePercent: 2.19, sparkline: [], volume: "12M",  marketCap: "70B"  },
  { symbol: "MSTR", name: "MicroStrategy — 마이크로스트래티지 비트코인",         price: 420.0,  change: 12.0, changePercent: 2.94, sparkline: [], volume: "14M",  marketCap: "55B"  },
  { symbol: "SMCI", name: "Super Micro Computer — 슈퍼마이크로",                 price: 45.0,   change: 1.2,  changePercent: 2.74, sparkline: [], volume: "20M",  marketCap: "26B"  },
  { symbol: "ARM",  name: "Arm Holdings — 암홀딩스 반도체 설계",                price: 135.0,  change: 2.5,  changePercent: 1.89, sparkline: [], volume: "8M",   marketCap: "142B" },
  { symbol: "TSM",  name: "Taiwan Semiconductor — TSMC 대만반도체",             price: 190.0,  change: 3.0,  changePercent: 1.60, sparkline: [], volume: "12M",  marketCap: "985B" },
  { symbol: "ASML", name: "ASML Holding — ASML 반도체 노광장비",                price: 850.0,  change: 10.0, changePercent: 1.19, sparkline: [], volume: "1.5M", marketCap: "365B" },
  { symbol: "CRWD", name: "CrowdStrike — 크라우드스트라이크 사이버보안",         price: 380.0,  change: 5.0,  changePercent: 1.33, sparkline: [], volume: "3M",   marketCap: "95B"  },
  { symbol: "PANW", name: "Palo Alto Networks — 팔로알토 사이버보안",            price: 390.0,  change: 4.5,  changePercent: 1.17, sparkline: [], volume: "2M",   marketCap: "127B" },
  { symbol: "AAON", name: "AAON Inc. — HVAC 공조 시스템",                      price: 80.0,   change: 0.8,  changePercent: 1.01, sparkline: [], volume: "0.5M", marketCap: "7B"   },
  { symbol: "VST",  name: "Vistra Corp — 비스트라 전력·에너지",                  price: 165.0,  change: 3.0,  changePercent: 1.85, sparkline: [], volume: "4M",   marketCap: "49B"  },
  { symbol: "CEG",  name: "Constellation Energy — 컨스텔레이션 원자력",          price: 280.0,  change: 4.0,  changePercent: 1.45, sparkline: [], volume: "2M",   marketCap: "82B"  },
];
