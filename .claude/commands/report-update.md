...
> **핵심: 이미지에 글 많이 넣지 말 것. 초보도 모바일에서 한눈에 이해.**
> 레퍼런스: `public/charts/*20260702*.svg` (예: `tsla-q2-delivery-day-20260702.svg`, `spcx-wedbush-150-20260702.svg`)

- **히어로 숫자** 크게 (대략 60~130px) — `$460`, `52%`, `D-DAY` 등
- **아이콘·이모지·카드·레인지바·간단 그래프**로 구조 표현
- 카드당 **핵심 지표/키워드 1개** — 긴 문장·불릿·문단 **절대 금지**
- SVG에 넣던 설명·배경·투자시사점 → **전부 `lib/reports.ts` body로**
- 모바일 가독성: 여백·대비·글자 밀도 (문장 가득 찬 이미지 금지)
- 색상: TSLA=`#00e5a0`/`#4ade80`, SPCX=`#c084fc`, NVDA/TSM/META=`#60a5fa`, 위험/BREAKING=`#ef4444`/`#f87171`
- XML에서 `&` → `&amp;` 필수

#### 한장요약 SVG

- 항목당: 짧은 헤드라인 + **키 숫자 1개** + 서브 한 줄
- 문장형 설명 여러 줄 금지 (상세는 개별 리포트 본문)
...
- **SVG = 큰 숫자·그림 / 본문 = 상세 글 + 투자시사점** — 내일부터의 기본 품질 기준 (스킬: `.cursor/skills/investus-report-update/`)
