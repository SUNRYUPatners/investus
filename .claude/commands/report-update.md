...
#### SVG 스타일 — 2026-07-15 업데이트: 7/2 메인 + 7/3 서브, 7/4 스타일 금지

> **7/4 스타일(배경 그리드 라인 + "핵심사실/투자시사점" 2단 카드 박스)로 만들었다가 반려됨 — 너무 인포그래픽/표 느낌이라 딱딱함.**
>
> **우선순위: 7/2가 메인 기준, 7/3은 서브(보완).** 항상 먼저 7/2 파일로 구조를 잡고, 소재에 맞는 게 없을 때만 7/3을 보조로 참고한다.
>
> 레퍼런스 (새 SVG 만들기 전에 비슷한 소재의 파일을 1~2개 Read):
> - **메인**: `public/charts/*20260702*.svg` (예: `tsla-q2-delivery-day`, `spcx-wedbush-150`, `meta-cloud-ai`)
