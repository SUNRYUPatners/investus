...
const WARNINGS = [
  ...
  },
  {
    emoji: "📊",
    title: "정보 제공 목적 명시",
    body: "Investus가 제공하는 모든 정보(주가, 지수, 뉴스, 분석, 13F 포트폴리오 공시 등)는 투자 판단의 참고 자료로만 제공됩니다. 본 서비스의 어떠한 내용도 특정 종목의 매수·매도를 권유하거나 투자 수익을 보장하지 않습니다.",
    color: "#60a5fa",
  ...
  },
  {
    emoji: "🔮",
    title: "과거 실적과 미래 성과",
    body: "제공되는 과거 수익률, 분석 데이터, 투자 대가의 포트폴리오 정보는 미래 수익을 보장하지 않습니다. 과거의 투자 성과가 미래에도 동일하게 반복되리라는 보장은 없습니다.",
    color: "#c084fc",
  ...
  },
  {
    emoji: "🌐",
    title: "환율 및 해외 투자 위험",
    body: "미국주식 투자 시 달러-원 환율 변동에 따른 환차손이 발생할 수 있습니다. 또한 미국의 세제, 법령, 경제 상황 변화에 따른 추가적인 위험이 존재합니다.",
    color: "#fb923c",
  ...
  },
  {
    emoji: "🏛️",
    title: "13F 공시 데이터 관련",
    body: "투자 대가의 포트폴리오 정보는 미국 SEC 13F 공시 및 의회 주식거래 공시(STOCK Act)에 기반합니다. 공시는 분기별로 이루어지므로 실제 현재 포트폴리오와 차이가 있을 수 있으며, 단순 모방 투자는 예상치 못한 손실을 초래할 수 있습니다.",
    color: "#facc15",
  ...
  },
  {
    emoji: "👤",
    title: "투자 책임은 본인에게",
    body: "모든 투자 판단과 그에 따른 결과(이익 또는 손실)는 전적으로 투자자 본인에게 귀속됩니다. 서비스는 투자 결과에 대해 어떠한 법적·도의적 책임도 지지 않습니다.",
    color: "#e8eaed",
  ...
  return (
    <div className="min-h-screen pb-safe" style={{ background: "var(--bg)" }}>
      ...
      <main className="max-w-[480px] lg:max-w-2xl mx-auto px-4 pb-24 lg:pb-10">
        ...
        <h1 className="text-lg font-bold font-syne mb-1" style={{ color: "var(--text)" }}>투자 유의사항</h1>
        <p className="text-[11px] mb-2" style={{ color: "var(--muted)" }}>Investus는 투자 정보 제공 플랫폼으로, 투자 권유·자문 서비스가 아닙니다.</p>
        ...
        >
          <p className="text-sm font-bold mb-3 font-syne" style={{ color: "var(--text)" }}>현명한 투자를 위한 조언</p>
