...
const WARNINGS_KO = [
  ...
  { emoji: "📰", title: "뉴스 및 외부 데이터", body: "서비스 내 뉴스, 시세, 재무 데이터는 외부 데이터 제공업체로부터 수집됩니다. 데이터의 정확성 및 최신성을 보장하지 않으며, 데이터 오류로 인해 발생한 손해에 대해 서비스는 책임을 지지 않습니다.", color: "#10b981", bg: "rgba(var(--mint-rgb),0.08)" },
...
const WARNINGS_EN = [
  ...
  { emoji: "📰", title: "News & External Data", body: "News, prices, and financial data within the Service are sourced from third-party data providers. Accuracy and timeliness of data are not guaranteed, and the Service assumes no liability for damages resulting from data errors.", color: "#10b981", bg: "rgba(var(--mint-rgb),0.08)" },
