...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "서비스는 광고 기반으로 운영되며, 이용자에게 모든 기능을 무료로 제공합니다. AI 질문, 리포트 열람, 투자채널 콘텐츠 이용 등에 별도 구독료가 부과되지 않습니다.\n투자채널 크리에이터에게는 콘텐츠 조회수 기반 광고 수익이 정산됩니다. 수익 정산 기준 및 금액은 서비스 운영 정책에 따르며 사전 공지 후 변경될 수 있습니다.",
  },
  {
    title: "제8조 (크리에이터 수익 정산)",
    body: "투자채널 크리에이터로 승인된 이용자는 콘텐츠 조회수에 비례한 광고 수익을 정산받을 수 있습니다.\n정산은 월 단위로 이루어지며, 최소 정산 금액 기준이 적용될 수 있습니다.\n정산을 위해서는 계좌 인증 및 본인 확인 절차가 완료되어야 합니다.\n크리에이터가 허위 정보를 게시하거나 이용약관을 위반한 경우 수익 정산이 중단될 수 있습니다.",
  },
  {
    title: "제9조 (지적재산권)",
