...
const SECTIONS_KO = [
  ...
  },
  {
    ...
    body: "서비스는 이용자 편의 제공, 서비스 개선, 광고 게재를 위해 쿠키·로컬 스토리지·유사 기술을 사용할 수 있습니다.\n\n[앱 기능]\n• localStorage: 포트폴리오, 즐겨찾기 등 앱 내 설정(서버로 전송되지 않음)\n• locale 쿠키: 언어 설정\n\n[광고 — Google AdSense / Kakao AdFit]\n• Google 및 제3자 광고 파트너는 쿠키 또는 유사 기술을 사용해 이전에 방문한 웹사이트 정보를 바탕으로 광고를 게재할 수 있습니다.\n• 이용자는 Google 광고 설정(https://adssettings.google.com)에서 맞춤 광고를 끄거나, www.aboutads.info 에서 관심 기반 광고를 거부할 수 있습니다.\n• 쿠키를 차단하면 일부 서비스 기능이 제한될 수 있습니다.",
  },
  {
...
const SECTIONS_EN = [
  ...
  },
  {
    ...
    body: "The Service may use cookies, localStorage, and similar technologies for convenience, improvement, and advertising.\n\n[App features]\n• localStorage: portfolio and watchlist settings (not sent to servers)\n• locale cookie: language preference\n\n[Advertising — Google AdSense / Kakao AdFit]\n• Google and third-party ad partners may use cookies or similar technologies based on prior website visits to serve ads.\n• Users can turn off personalized ads at https://adssettings.google.com or opt out of interest-based ads at www.aboutads.info.\n• Blocking cookies may limit some features.",
  },
  {
