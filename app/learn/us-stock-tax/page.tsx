...
export const metadata: Metadata = {
  ...
  description:
    "국내 증권사로 미국주식을 할 때 알아둘 양도소득세, 배당 원천징수, 금융소득종합과세, 환율 손익의 개념을 교육 목적으로 정리합니다. 세무 자문이 아닙니다.",
  keywords: ["미국주식 세금", "양도소득세", "배당세", "해외주식 세금", "금융소득종합과세"],
    ...
    <div className="min-h-screen pb-safe" style={{ background: "var(--bg)" }}>
      ...
      <main className="max-w-[480px] lg:max-w-2xl mx-auto px-4 pb-10">
        ...
        <article className="flex flex-col gap-6" style={{ color: "var(--muted)" }}>
          ...
          <section>
            <h2 className="text-base font-bold mb-3" style={{ color: "var(--text)" }}>매매 차익: 양도소득</h2>
            <p className="text-sm leading-relaxed mb-3">
            ...
            <p className="text-sm leading-relaxed mb-3">
              환율도 손익에 들어갑니다. 달러 주가가 그대로여도 원화가 강해지면 원화 환산 이익이 줄거나 손실이 날 수 있습니다.
              반대로 주가가 빠져도 달러가 크게 오르면 원화로는 덜 아픈 구간이 나옵니다.
              <Link href="/learn/usd-krw" style={{ color: "var(--mint)" }}>환율 가이드</Link>와 함께 보세요.
            </p>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed mb-3">
              미국 기업·ETF 배당은 미국에서 일정 세율로 원천징수되는 경우가 많습니다.
              한·미 조세조약이 적용되면 15%대가 흔히 언급됩니다. 증권사 입금 내역의
              &ldquo;세전 배당 / 원천세 / 실입금&rdquo;을 구분해 보관하세요.
            </p>
            <p className="text-sm leading-relaxed mb-3">
              국내에서는 금융소득으로 합산될 수 있습니다. 이자·배당이 많아지면 종합과세 여부를 살펴야 합니다.
              고배당 전략일수록 세후 수익률을 따로 계산하는 습관이 필요합니다.
            </p>
            <p className="text-sm leading-relaxed">
              REIT·일부 펀드 분배는 일반 배당과 세무 처리가 다를 수 있습니다.
              ETF 상품설명서의 분배금 성격과 증권사 원천징수 내역을 대조하세요.
              상품 구조는 <Link href="/learn/etf" style={{ color: "var(--mint)" }}>ETF 가이드</Link>를 참고하면 됩니다.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-base font-bold mb-3" style={{ color: "var(--text)" }}>더 읽을 글</h2>
            <p className="text-sm leading-relaxed">
              입문 전체는 <Link href="/learn/us-stock-basics" style={{ color: "var(--mint)" }}>미국주식 입문</Link>,
              상품은 <Link href="/learn/etf" style={{ color: "var(--mint)" }}>ETF</Link>,
              문의는 <Link href="/more/contact" style={{ color: "var(--mint)" }}>연락처</Link>를 이용하세요.
              세금 계산 요청은 받지 않습니다.
            </p>
          </section>
            ...
            <Link href="/learn/dca" style={{ textDecoration: "none" }}>
              <div className="rounded-2xl p-4 border flex items-center gap-3 active:opacity-70" style={{ background: "var(--card)", borderColor: "var(--border)" }}>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[11px]" style={{ color: "var(--muted)" }}>환율까지 분산하는 적립</p>
                </div>
                <ChevronLeft className="w-4 h-4 rotate-180 opacity-30" style={{ color: "var(--muted)" }} />
              </div>
            </Link>
