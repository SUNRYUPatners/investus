...
공식 리포트 말고 익명 투자자 커뮤니티에 시황 코멘트를 짧게 남길 거야.
...
- "공식 리포트엔 못 쓰지만", "내부에선", "개인적으론", "팀에서 보면" 같은 표현 자연스럽게 섞기
- "솔직히"라는 단어 사용 금지
- 매수/매도 직접 권유 금지
- 이모지 없음
...
익명 투자자 커뮤니티 '애널들은 탭'에 오늘의 시황 코멘트를 남길 거야.
...
- "공식 리포트엔 못 쓰지만", "내부에선", "개인 계좌로는", "팀에서", "우리 쪽에서 보면" 같은 표현 자연스럽게 포함
- "솔직히"라는 단어는 절대 사용 금지
- 매수/매도 직접 권유 금지
- 이모지 없음
- 코멘트 내용만 바로 출력`;
