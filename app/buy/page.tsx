  ...
  return (
    <div className="min-h-screen pb-safe" style={{ background: "var(--bg)" }}>
      ...
      <main className="max-w-[480px] lg:max-w-xl mx-auto px-4 lg:px-8 pt-4 pb-12 lg:pb-10">
        <Link href="/shop" className="inline-flex items-center gap-1 text-xs mb-5" style={{ color: "var(--muted)" }}>
          <ChevronLeft className="w-3.5 h-3.5" /> 유료 상품 스토어
        </Link>
        ...
        <p className="text-[11px] mb-5" style={{ color: "var(--muted)" }}>
          판매가 {fmt(BOOK.price)} · 디지털 콘텐츠 (실물 배송 없음)
        </p>
        ...
        <div className="rounded-xl p-4 border mb-4" style={{ background: "rgba(255,255,255,0.02)", borderColor: "var(--border)" }}>
          <p className="text-[10px] leading-relaxed mb-3" style={{ color: "var(--muted)" }}>
            ...
            <Link href="/more/refund" className="underline ml-1" style={{ color: "var(--mint)" }}>환불정책 전문</Link>
          ...
          <label className="flex items-start gap-2 cursor-pointer">
            ...
            <span className="text-[11px] leading-relaxed" style={{ color: "var(--muted)" }}>
              위 구매 조건 및 <Link href="/more/refund" className="underline" style={{ color: "var(--mint)" }}>환불정책</Link>을 확인하였으며, 전자책 구매에 동의합니다.
            </span>
          </label>
        </div>
