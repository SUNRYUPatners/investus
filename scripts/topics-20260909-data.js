...
add('summary', 'ROWS', 'MACRO', {
  ...
  rows: [
    { color:'#4ade80', fill:'#061209', right:'TSLA', title:'유럽 사이버캡은 「곧」입니다',
      sub:'확정 날짜 없이 유럽 출시 톤만 남았습니다. 미국 요금·대기와 칸을 나누시기 바랍니다.' },
    { color:'#22c55e', fill:'#061209', right:'댈러스', title:'댈러스 로보택시 허브가 커졌습니다',
      sub:'표시 모델Y 약 40대·검증용 사이버캡 75대 이상이 거론됐습니다.' },
    { color:'#22d3ee', fill:'#06171c', right:'플릿', title:'텍사스 자율차 대수가 공개됐습니다',
      sub:'9월 8일 기준 웨이모 988·테슬라 432·애브라이드 344·죽스 44대입니다.' },
    { color:'#38bdf8', fill:'#06121f', right:'AI5', title:'테일러 팹·인공지능5 40배입니다',
      sub:'풀가동 전 양산·공동설계 약 40배(원 연산 약 8배와 구분)입니다.' },
    { color:'#c084fc', fill:'#140b1f', right:'SPCX', title:'스페이스X 목표가 220달러입니다',
      sub:'매수 의견에 시총 약 +720억 달러·지분 약 48.4%가 붙었습니다.' },
    { color:'#ef4444', fill:'#1a0a0a', right:'MACRO', title:'일본 이자·중국 은행 마진입니다',
      sub:'이자 약 16.59조 엔 사상 최고·순이자마진 약 1.4%가 같은 표입니다.' },
    { color:'#60a5fa', fill:'#06121f', right:'GOOGL', title:'제미니 엔터프라이즈 1,000명입니다',
      sub:'구글–액센추어 유닛 서사와 콜로라도 메가팩이 같은 아침입니다.' },
  ],
  caption: '더 볼 것: 유럽곧 · 댈러스 · 텍사스플릿 · AI5 · PT220 · 16.59조엔 · NIM1.4% · 제미니 · 메가팩',
}, {
  headline: '2026.09.09 Daily Snapshot',
  rows: [
    { color:'#4ade80', fill:'#061209', right:'TSLA', title:'Europe Cybercab framed as “soon”',
      sub:'No locked date—keep EU timing apart from US fare and wait prints.' },
    { color:'#22c55e', fill:'#061209', right:'Dallas', title:'Dallas robotaxi hub is expanding',
      sub:'About 40 marked Model Y and 75+ validation Cybercabs were cited.' },
    { color:'#22d3ee', fill:'#06171c', right:'Fleet', title:'Texas AV fleet sizes printed',
      sub:'Sep 8: Waymo 988 · Tesla 432 · Avride 344 · Zoox 44.' },
    { color:'#38bdf8', fill:'#06121f', right:'AI5', title:'Taylor fab and AI5 ~40x story',
      sub:'Full before mass production; co-design ~40x vs raw compute ~8x.' },
    { color:'#c084fc', fill:'#140b1f', right:'SPCX', title:'SpaceX Buy target $220',
      sub:'About +$72B market-cap day; Musk stake ~48.4% on the same board.' },
    { color:'#ef4444', fill:'#1a0a0a', right:'MACRO', title:'Japan interest and China NIM',
      sub:'Japan bill ATH ~¥16.59T; China bank NIM near 1.4%.' },
    { color:'#60a5fa', fill:'#06121f', right:'GOOGL', title:'Gemini Enterprise ~1,000 engineers',
      sub:'Google–Accenture unit story; Colorado Megapack also this morning.' },
  ],
  caption: 'Watch: Europe soon · Dallas · TX fleet · AI5 · PT220 · ¥16.59T · NIM 1.4% · Gemini · Megapack',
});
