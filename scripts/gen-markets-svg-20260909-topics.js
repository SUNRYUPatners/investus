...
add("summary-kr", "ROWS", "KOSPI", {
  ...
  rows: [
    { color:"#38bdf8", fill:"#061520", right:"−0.58%", title:"코스피가 6,954.52로 마감했습니다", sub:"장중 약 7,171까지 올랐다 되돌렸고, 코스닥은 811.88(−1.25%)입니다." },
    { color:"#ef4444", fill:"#1a0a0a", right:"유가", title:"중동 유가 급등이 겹쳤습니다", sub:"브렌트 약 98달러·서부텍사스산 약 94달러, 미국 10년물 약 4.8% 서사입니다." },
    { color:"#22d3ee", fill:"#06171c", right:"수급", title:"개인 매도·외인·기관 매수입니다", sub:"개인 약 3.0~3.3조 원 매도, 외국인·기관 각각 약 6조 원대 매수입니다." },
    { color:"#60a5fa", fill:"#0a1420", right:"삼성", title:"삼성전자 26만 9,500원입니다", sub:"하루 −0.19%였고, 테일러 팹·인공지능5 서사는 개별 축으로 둡니다." },
    { color:"#f59e0b", fill:"#1a1205", right:"하이닉스", title:"하이닉스 179만 3,000원입니다", sub:"+0.56%이고, 9월 10일 반도체 지수 리밸런싱 매도 추정이 있습니다." },
    { color:"#a78bfa", fill:"#120b1f", right:"리밸런", title:"반도체 리밸런싱이 내일입니다", sub:"비중 상한으로 약 1.4~1.7조 원대 매도 추정, 적용은 11일부터입니다." },
    { color:"#fb923c", fill:"#1a0d02", right:"시총", title:"엘지엔솔·현대·케이비가 약세입니다", sub:"엘지엔솔 −3.86%·현대차 약 −2.04%·케이비 약 −1.25%로 온도가 달랐습니다." },
  ],
  caption: "더 볼 것: 6954.52 · 유가·금리 · 수급 · 리밸런싱 9/10 · 시총 온도",
}, {
  headline: "2026.09.09 Korea Market Snapshot",
  rows: [
    { color:"#38bdf8", fill:"#061520", right:"−0.58%", title:"KOSPI closed at 6,954.52", sub:"Intraday high near 7,171 then reversed; KOSDAQ 811.88 (−1.25%)." },
    { color:"#ef4444", fill:"#1a0a0a", right:"Oil", title:"Middle East oil spike overlapped", sub:"Brent ~$98, WTI ~$94; 10y UST near 4.8% on the same board." },
    { color:"#22d3ee", fill:"#06171c", right:"Flow", title:"Retail sold; foreign/inst bought", sub:"Individuals ~₩3.0–3.3T sold; foreign and institutions ~₩6T each bought." },
    { color:"#60a5fa", fill:"#0a1420", right:"SMSN", title:"Samsung finished at 269,500", sub:"−0.19% day; Taylor/AI5 stays on its own axis." },
    { color:"#f59e0b", fill:"#1a1205", right:"Hynix", title:"Hynix finished at 1,793,000", sub:"+0.56%; Sep 10 semi-index rebalance selling estimates ahead." },
    { color:"#a78bfa", fill:"#120b1f", right:"Rebal", title:"Semi rebalance is tomorrow", sub:"~₩1.4–1.7T estimated sells from weight caps; applies from Sep 11." },
    { color:"#fb923c", fill:"#1a0d02", right:"Peers", title:"LGES, Hyundai, KB softer", sub:"LGES −3.86%, Hyundai ~−2.04%, KB ~−1.25%—different temperatures." },
  ],
  caption: "Watch: 6954.52 · oil/rates · flows · rebalance 9/10 · peer temps",
});
...
add("summary-safe", "ROWS", "GOLD", {
  ...
  rows: [
    { color:"#facc15", fill:"#1a1600", right:"금", title:"금이 온스 약 4,400달러입니다", sub:"연준 9월 16일 회의를 앞두고 온스 밴드가 버텼습니다." },
    { color:"#f59e0b", fill:"#1a1600", right:"확률", title:"인상 확률이 동전 던지기입니다", sub:"폴리마켓 인상 약 51.5%·동결 약 47.5%, 씨엠이는 종종 더 높습니다." },
    { color:"#f7931a", fill:"#1a0f00", right:"BTC", title:"비트코인이 8만 달러를 내줬습니다", sub:"약 7만 8,300~7만 8,500달러대에서 금과의 상관 서사가 커졌습니다." },
    { color:"#f97316", fill:"#1a0d02", right:"원유", title:"브렌트가 약 98달러입니다", sub:"중동 타격 서사와 겹칩니다. 금·비트코인과 칸을 나누시기 바랍니다." },
    { color:"#94a3b8", fill:"#0c1017", right:"달러", title:"달러·금리가 공통 분모입니다", sub:"8월 소비자물가(11일)·연방공개시장위원회(15~16일)가 같은 주입니다." },
    { color:"#cbd5e1", fill:"#111827", right:"은", title:"은은 금과 다른 줄입니다", sub:"헤지와 산업 수요가 겹칩니다. 금은비율·달러를 같이 보시면 됩니다." },
    { color:"#22d3ee", fill:"#06171c", right:"캘린더", title:"물가·회의가 한 주에 있습니다", sub:"11일 물가와 15~16일 회의가 안전자산 변동성의 다음 게이트입니다." },
  ],
  caption: "더 볼 것: 금 ~4400 · 인상확률 갈림 · BTC 78k대 · 브렌트 ~98 · CPI·FOMC",
}, {
  headline: "2026.09.09 Safe-Assets Snapshot",
  rows: [
    { color:"#facc15", fill:"#1a1600", right:"Gold", title:"Gold holds near $4,400/oz", sub:"The ounce band held into the Sep 16 Fed meeting." },
    { color:"#f59e0b", fill:"#1a1600", right:"Odds", title:"Hike odds look like a coin flip", sub:"Polymarket ~51.5% hike / 47.5% hold; CME often prints higher." },
    { color:"#f7931a", fill:"#1a0f00", right:"BTC", title:"Bitcoin lost the $80,000 handle", sub:"Trades ~$78,300–78,500 with a louder gold-correlation narrative." },
    { color:"#f97316", fill:"#1a0d02", right:"Oil", title:"Brent sits near $98", sub:"Overlaps Middle East strike narrative—split from gold/BTC cells." },
    { color:"#94a3b8", fill:"#0c1017", right:"USD", title:"Dollar and rates are the common factor", sub:"Aug CPI on Sep 11 and FOMC on Sep 15–16 share the week." },
    { color:"#cbd5e1", fill:"#111827", right:"Silver", title:"Silver is not just mini-gold", sub:"Haven plus industrial demand; watch gold/silver ratio and DXY." },
    { color:"#22d3ee", fill:"#06171c", right:"Calendar", title:"CPI and FOMC land this week", sub:"Those two prints are the next volatility gates for safe assets." },
  ],
  caption: "Watch: gold ~4400 · split hike odds · BTC 78k · Brent ~98 · CPI/FOMC",
});
...
add("summary-krre", "ROWS", "JEONSE", {
  ...
  rows: [
    { color:"#fb923c", fill:"#1a0d02", right:"전세", title:"갱신권 없이 올린 전세가 많습니다", sub:"7월 서울 아파트 재계약의 약 88%가 보증금을 올렸습니다." },
    { color:"#f97316", fill:"#1a0d02", right:"+4680만", title:"평균 인상액이 약 4,680만 원입니다", sub:"약 9.1% 인상입니다. 갱신권 사용 시 평균은 약 2,750만 원입니다." },
    { color:"#ef4444", fill:"#1a0a0a", right:"꼬리", title:"큰 인상 꼬리도 있습니다", sub:"1억 원 이상 360건·3억 원 이상 20건입니다. 평균과 같이 보시면 됩니다." },
    { color:"#a78bfa", fill:"#120b1f", right:"매물", title:"전세 매물이 약 12% 줄었습니다", sub:"서울 전세 매물 약 20,432건으로 전년 대비 감소했습니다." },
    { color:"#38bdf8", fill:"#061520", right:"지수", title:"전세가격지수가 101.9입니다", sub:"2022년 10월 이후 가장 높은 수준으로 집계됐습니다." },
    { color:"#22d3ee", fill:"#06171c", right:"월세", title:"전세의 월세화가 이어집니다", sub:"순수 전세에서 월세로 바뀌는 전환과 가을 이사 시즌이 겹칩니다." },
    { color:"#c084fc", fill:"#140b1f", right:"정책", title:"실거주·허가구역은 다른 칸입니다", sub:"공급은 느리고 규제는 빠릅니다. 전세 숫자와 합치지 마시기 바랍니다." },
  ],
  caption: "더 볼 것: 인상 88% · +4680만 · 매물 20432 · 지수 101.9 · 가을 이사",
}, {
  headline: "2026.09.09 Korea Real-Estate Snapshot",
  rows: [
    { color:"#fb923c", fill:"#1a0d02", right:"Jeonse", title:"Most no-right renewals raised deposits", sub:"About 88% of Seoul July apt renewals without renewal-right raised." },
    { color:"#f97316", fill:"#1a0d02", right:"+₩46.8M", title:"Average raise near ₩46.8 million", sub:"About +9.1%; with renewal-right the average was near ₩27.5 million." },
    { color:"#ef4444", fill:"#1a0a0a", right:"Tails", title:"Large-raise tails also printed", sub:"360 cases ₩100M+ and 20 cases ₩300M+—read with averages." },
    { color:"#a78bfa", fill:"#120b1f", right:"Listings", title:"Jeonse listings fell about 12%", sub:"Seoul listings near 20,432 versus a year earlier." },
    { color:"#38bdf8", fill:"#061520", right:"Index", title:"Jeonse price index at 101.9", sub:"Highest level since October 2022." },
    { color:"#22d3ee", fill:"#06171c", right:"Wolse", title:"Jeonse-to-wolse keeps spreading", sub:"Pure-jeonse conversions overlap autumn moving-season risk." },
    { color:"#c084fc", fill:"#140b1f", right:"Policy", title:"Permit zones stay in another cell", sub:"Supply is slow; rules are fast—do not mash with jeonse stats." },
  ],
  caption: "Watch: 88% raises · +₩46.8M · 20,432 listings · index 101.9 · autumn moves",
});
