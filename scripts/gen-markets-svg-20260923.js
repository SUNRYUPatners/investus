...
const P = {
  ...
  BANK:   { fg:'#34d399', fg2:'#10b981', bg2:'#052015', card:'#08251c' },
  XRP:    { fg:'#38bdf8', fg2:'#0ea5e9', bg2:'#0a1a20', card:'#0e2028' },
  TOHEO:  { fg:'#a78bfa', fg2:'#8b5cf6', bg2:'#120b1f', card:'#180f28' },
  BIO:    { fg:'#34d399', fg2:'#10b981', bg2:'#052015', card:'#08251c' },
  LGES:   { fg:'#22d3ee', fg2:'#06b6d4', bg2:'#06171c', card:'#0a1c22' },
};
...
require('./gen-markets-svg-20260923-topics.js')(add);
