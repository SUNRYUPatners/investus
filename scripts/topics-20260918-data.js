...
add('harvard-spcx-51pct', 'L5', 'SPCX', {
  ...
  heroSub: '기부금 펀드는 대학이 오래 굴리는 큰 투자 주머니입니다. 하버드가 공개한 2분기 상장·장외 주식 42억 달러 가운데 스페이스X가 절반을 넘었습니다.',
  before: { label: '2위 TSMC', big: '7.9%', sub: '대만 파운드리 비중' },
  after: { label: '1위 스페이스X', big: '51.5%', sub: '한 종목이 포트의 절반' },
  cards: [
    { icon:'\u{1F4B0}', big:'42억불', mid:'2분기 주식 포트', sub:'2026년 2분기 공시 기준입니다' },
    { icon:'\u{1F3E6}', big:'TSMC 7.9%', mid:'두 번째 비중', sub:'파운드리 대장과 비교해도 격차가 큽니다' },
    { icon:'\u{1F4CA}', big:'CBRS 5.9%', mid:'세 번째 비중', sub:'상위 세 종목이 포트의 65%를 넘습니다' },
  ],
  quote: '대학 기부금은 보통 여러 자산에 나눠 담습니다. 한 비상장 로켓 회사가 주식 포트의 절반을 넘는 것은 이례적입니다. 하버드가 스페이스X 상장 전 몸값을 오래 들고 가겠다는 뜻으로 읽힙니다.',
  noteHead: '왜 중요한가', noteSub: '대형 대학 자금이 이 비중을 유지하면 장외 수요가 받쳐 집니다. 반대로 비중을 줄이면 차익 실현 신호가 됩니다. 다음 분기 공시에서 51.5%가 유지되는지를 보면 됩니다.',
  footer: '스페이스X · 하버드 포트',
}, {
  badge: 'SPCX', title: 'Harvard’s endowment held SpaceX as 51.5% of a $4.2 billion Q2 equity book',
  heroIcon: '\u{1F393}', heroBig: 'SPCX 51.5%',
  heroSub: 'An endowment is a university’s long-term investment pool. Harvard’s published Q2 listed-and-private equity book of $4.2 billion had SpaceX as more than half.',
  before: { label: 'No.2 TSMC', big: '7.9%', sub: 'Taiwan foundry weight' },
  after: { label: 'No.1 SpaceX', big: '51.5%', sub: 'One name, half the book' },
  cards: [
    { icon:'\u{1F4B0}', big:'$4.2B', mid:'Q2 equity book', sub:'As disclosed for Q2 2026' },
    { icon:'\u{1F3E6}', big:'TSMC 7.9%', mid:'Second-largest line', sub:'Still a wide gap versus SpaceX' },
    { icon:'\u{1F4CA}', big:'CBRS 5.9%', mid:'Third-largest line', sub:'Top three names exceed 65%' },
  ],
  quote: 'Endowments usually spread bets. One pre-IPO rocket company above 50% of the equity book is unusual. It reads as Harvard choosing to live with SpaceX’s private-market price for longer.',
  noteHead: 'Why it matters', noteSub: 'If a large university keeps this weight, secondary demand has a bid. A cut would look like profit-taking. Watch whether 51.5% still prints in the next quarterly filing.',
