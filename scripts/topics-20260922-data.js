...
add('tsla-model-y-l-soldout', 'L5', 'TSLA', {
  badge: '테슬라', title: '모델Y 론치 시리즈 미국 주문이 2027년 1~2월 인도입니다',
  heroIcon: '\u{1F697}', heroBig: '2027년 초',
  heroSub: '론치 시리즈는 먼저 나오는 특별 사양입니다. 주문 화면은 콜로라도 아르바다 기준 인도 예상일을 2027년 1~2월로 보여 줬습니다.',
  before: { label: '2026 물량', big: '소진', sub:'올해 미국 물량은 사실상 끝났다는 설명입니다' },
  after: { label: '새 주문', big: '1–2월', sub:'2027년 1월에서 2월 인도입니다' },
  cards: [
    { icon:'\u{1F4CD}', big:'아르바다', mid:'콜로라도 주문 화면', sub:'우편번호 80001이 찍혔습니다' },
    { icon:'\u{1F697}', big:'모델Y', mid:'긴 축거 론치 사양으로 읽힙니다', sub:'일반 모델Y와 대기줄이 다릅니다' },
    { icon:'\u{1F4C5}', big:'변동', mid:'인도 창은 생산에 따라 움직입니다', sub:'화면 한 장이 확정 계약은 아닙니다' },
  ],
  quote: '수요가 가까운 생산을 앞질렀다는 신호입니다. 창이 2027년으로 밀린 것이지 주문이 닫힌 것은 아닙니다.',
  noteHead: '왜 중요한가', noteSub: '대기줄이 길면 가까운 매출은 이미 잡혀 있고 내년 인도가 쌓입니다. 화면은 지역·사양마다 다릅니다. 다음엔 다른 우편번호 창과 공장 주간 생산을 보면 됩니다.',
  footer: '테슬라 · 모델Y 론치',
}, {
  badge: 'TSLA', title: 'New US Model Y Launch Series orders now show January–February 2027 delivery',
  heroIcon: '\u{1F697}', heroBig: 'Early 2027',
  heroSub: 'Launch Series is the first special spec. The order page for Arvada, Colorado showed an estimated delivery of January–February 2027.',
  before: { label: '2026 slots', big: 'Gone', sub:'This year’s US allocation is described as spent' },
  after: { label: 'New order', big: 'Jan–Feb', sub:'Delivery in early 2027' },
  cards: [
    { icon:'\u{1F4CD}', big:'Arvada', mid:'A Colorado order screen', sub:'ZIP 80001 was on the page' },
    { icon:'\u{1F697}', big:'Model Y', mid:'Read as the long-wheelbase Launch spec', sub:'The wait differs from a standard Y' },
    { icon:'\u{1F4C5}', big:'Moves', mid:'Windows shift with production', sub:'One screen is not a locked contract' },
  ],
  quote: 'Demand has run ahead of near-term output. The window slipped into 2027; the order book did not close.',
  noteHead: 'Why it matters', noteSub: 'A long queue means near sales are already booked and next-year deliveries stack up. Screens differ by ZIP and spec. Next, watch other ZIP windows and weekly factory output.',
  footer: 'Tesla · Model Y Launch',
});
