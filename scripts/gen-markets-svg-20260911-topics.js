...
add("summary-kr", "ROWS", "KOSPI", {
  ...
  rows: [
    ...
    { color:"#22d3ee", fill:"#06171c", right:"외인", title:"외국인이 2조 4,820억 원을 팔고 기타법인이 1조 6,670억 원을 샀습니다",
      sub:"개인 3,801억·기관 4,334억 매수입니다. 네 마녀의 날과 칸을 나누시기 바랍니다." },
    ...
    { color:"#a78bfa", fill:"#120b1f", right:"삼바", title:"삼성바이오로직스가 1,423,000원(−2.00%)이었습니다",
      sub:"제약 업종 약세와 같은 줄기입니다. 반도체 베타와 합치지 마시기 바랍니다." },
...
add("kospi-flow-kr", "L6", "KOSPI", {
  ...
  quote: "7,000선 사수는 종가 기준입니다. 장중 6,898 저점과 외국인 매도를 한 문장의 추세로 합치지 마시기 바랍니다. 다음 확인할 것은 외국인 연속 매도 여부입니다.",
  noteSub: "기타법인 순매수는 자사주 매입이 포함된 칸입니다. 유가 100달러·미국 10년 4.9%권과 칸을 나누시기 바랍니다. 장기적으로 코스피는 반도체 비중과 외국인 지분의 교집합입니다.",
  footer: "코스피 · 7,000 사수",
}, {
...
add("hynix-kr", "L1", "HYNIX", {
  ...
  quote: "장중 고점과 저점 폭이 큽니다. 외국인 매도를 종가 약보합의 원인으로 단정하지 마시기 바랍니다. 자사주 방파제와 칸을 나누시기 바랍니다.",
...
add("samsung-bio-kr", "L4", "SEC", {
  ...
  quote: "바이오 낙폭을 반도체 외국인 매도의 연장으로 읽지 마시기 바랍니다. 위탁생산 수주와 종가를 나누시기 바랍니다. 다음 확인할 것은 공장 가동률입니다.",
...
add("hyundai-kr", "L5", "AUTO", {
  ...
  quote: "유가와 금리는 완성차 할부·연료비 칸입니다. 로보택시 뉴스는 중기 칸에만 두시기 바랍니다. 반도체 약보합을 현대차 강세로 읽지 마시기 바랍니다.",
  noteSub: "상대 성과가 포인트입니다. 판매·인센티브 전엔 추격하지 마시기 바랍니다. 다음 확인할 것은 출하입니다. 전동화·소프트웨어가 장기 해자입니다.",
  footer: "현대차 · +0.26%",
}, {
...
add("summary-safe", "ROWS", "GOLD", {
  ...
  rows: [
    { color:"#f7931a", fill:"#1a0f00", right:"BTC", title:"비트코인이 7만 7천~7만 8천 달러권에서 약세를 이어 갔습니다",
      sub:"8만 달러 회복은 실패입니다. 생산자물가 5.4%와 칸을 나누시기 바랍니다." },
...
add("eth-safe", "L3", "ETH", {
  ...
  heroSub: "이더리움은 스마트계약 네트워크의 토큰입니다. 약 2,460달러권으로 비트코인보다 조금 더 약할 수 있습니다. 알트 레버리지부터 줄이시기 바랍니다.",
  cards: [
...
add("oil-safe", "L6", "OIL", {
  ...
  noteSub: "유가는 인플레 입력이지 안전자산이 아닙니다. 10년 4.92%와 한 문장의 헤지로 합치지 마시기 바랍니다. 장기적으로 공급 차질이 지속되면 에너지 비중이 커집니다.",
...
add("rates-safe", "L1", "RATES", {
  ...
  quote: "바이백 규모와 금리 상승을 한 줄의 완화로 합치지 마시기 바랍니다. 금·비트코인 할인율과 칸을 나누시기 바랍니다. 다음 확인할 것은 소비자물가입니다.",
...
add("summary-krre", "ROWS", "POLICY", {
  ...
  rows: [
    ...
    { color:"#22d3ee", fill:"#06171c", right:"공급", title:"브라운스톤 목동은 전체 85세대, 일반분양은 29세대입니다",
      sub:"계약은 9월 11~12일입니다. 서울 공급 가뭄과 한 단지를 합치지 마시기 바랍니다." },
    { color:"#4ade80", fill:"#061209", right:"입주", title:"서초 전세 약세는 잠원·반포 입주 영향으로 설명됐습니다",
      sub:"4주 연속 하락입니다. 매매 약세와 칸을 나누시기 바랍니다." },
...
add("seoul-split-krre", "L5", "POLICY", {
  ...
  quote: "도시 평균은 구별 키를 가립니다. 강남 약세를 서울 하락으로 읽지 마시기 바랍니다. 다음 확인할 것은 구별 실거래입니다.",
  noteSub: "세제 불확실성이 강남 고가에 더 붙었다는 설명이 있습니다. 전세 노원·서초와 칸을 나누시기 바랍니다. 장기적으로 학군·직주 수요가 가격보다 느린 축입니다.",
  footer: "서울 · 강남·강북 키맞춤",
}, {
...
add("seoul-supply-krre", "L6", "POLICY", {
  ...
  noteSub: "후분양은 공정을 보고 들어갑니다. 전세 노원 상승과 칸을 나누시기 바랍니다. 장기적으로 서울 입주 가뭄이 전세 키를 밀어 올릴 수 있습니다.",
  footer: "공급 · 목동 85세대",
}, {
