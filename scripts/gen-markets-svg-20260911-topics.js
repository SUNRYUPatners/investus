...
add("summary-kr", "ROWS", "KOSPI", {
  ...
  rows: [
    ...
    { color:"#22d3ee", fill:"#06171c", right:"외인", title:"외국인이 2조 4,820억 원을 팔고 기타법인이 1조 6,670억 원을 샀습니다",
      sub:"개인 3,801억·기관 4,334억 매수입니다. 선물·옵션이 같은 날 만기인 네 마녀의 날이었습니다." },
    ...
    { color:"#f59e0b", fill:"#1a1205", right:"하이닉스", title:"하이닉스는 1,853,000원(−0.16%)입니다",
      sub:"장중 1,890,000~1,811,000원입니다. 기관이 5,615억 원을 사며 종가를 지켰습니다." },
    ...
    { color:"#fb7185", fill:"#1a0a10", right:"현대", title:"현대차는 389,000원(+0.26%)으로 온도가 달랐습니다",
      sub:"유가·할부 수요 축입니다. 지수는 내렸는데 완성차만 소폭 올랐습니다." },
  ],
...
add("kospi-flow-kr", "L6", "KOSPI", {
  ...
  quote: "종가 7,033.92는 장중 6,898까지 밀렸다가 되돌린 숫자입니다. 외국인 2.48조 매도에도 종가 7,000선을 지켰습니다. 다음에 보면 좋은 것은 외국인이 하루 더 파는지입니다.",
  noteSub: "기타법인 1.67조 매수에는 자사주 매입이 포함됩니다. 유가 100달러와 미국 10년 4.9%권이 같은 아침의 바깥 온도입니다. 장기적으로 코스피는 반도체 비중과 외국인 지분이 커지는 지수입니다.",
  footer: "코스피 · 7,000 사수",
}, {
...
add("samsung-kr", "L2", "SEC", {
  ...
  detailHead: "종가와 수급이 보여 주는 것",
  detailLines: ["📍 종가는 269,000원, 하루 −0.19%입니다","🏦 기관 +1.01조, 외국인 −1.41조입니다","💵 하이닉스도 −0.16%로 비슷한 온도입니다"],
  noteSub: "외국인이 1.41조를 팔고 기관이 1.01조를 사며 269,000원(−0.19%)으로 마감했습니다. 장중 263,500원까지 밀렸다 대부분 되돌렸습니다. 장기적으로 메모리 사이클과 파운드리 수율이 회사의 힘입니다.",
  footer: "삼성전자 · 269,000",
}, {
...
add("hynix-kr", "L1", "HYNIX", {
  ...
  quote: "장중 1,890,000원에서 1,811,000원까지 출렁인 뒤 1,853,000원(−0.16%)으로 마감했습니다. 외국인 1.78조 매도를 기관 5,615억 매수가 받쳤습니다.",
  noteSub: "반도체 지수 리밸런싱 매물이 겹쳤다는 설명이 있습니다. 삼성 −0.19%와 비슷한 하루입니다. 장기적으로 고대역폭 메모리 점유가 이 회사의 힘입니다.",
...
add("lges-kr", "L3", "AUTO", {
  ...
  heroSub: "종가 365,000원은 전일 371,000원 대비 1.62% 내린 자리입니다. 브렌트 101달러권은 배터리 원가와 전기차 수요에 같이 닿습니다. 전일 +6.46% 다음날 되돌림이 겹쳤습니다.",
  cards: [
  ...
  quote: "365,000원(−1.62%)은 삼성·하이닉스보다 낙폭이 컸습니다. 유가 101달러와 금리 4.92%가 원가·할부 수요를 흔든 하루입니다. 다음에 보면 좋은 것은 수주와 전기차 출하입니다.",
  noteSub: "전일 +6.46% 다음날 되돌림이 겹쳤습니다. 에너지저장과 전고체 로드맵이 앞으로 3~5년 이야기의 뼈대입니다. 다음에 보면 좋은 것은 전기차 출하입니다.",
...
add("samsung-bio-kr", "L4", "SEC", {
  ...
  quote: "1,423,000원(−2.00%)은 제약 업종이 약한 날의 종가입니다. 위탁생산 수주가 없는 하루라 업종 베타가 더 보였습니다. 다음에 보면 좋은 것은 공장 가동률입니다.",
...
add("hyundai-kr", "L5", "AUTO", {
  ...
  quote: "389,000원(+0.26%)은 코스피 −0.25%, 엔솔 −1.62%와 온도가 달랐습니다. 유가 101달러와 금리 4.92%는 할부와 연료비로 완성차에 닿습니다.",
  noteSub: "지수가 내린 날 완성차만 소폭 오른 상대 성과가 포인트입니다. 전동화와 소프트웨어가 앞으로 3~5년 힘입니다. 다음에 보면 좋은 것은 월간 출하입니다.",
  footer: "현대차 · +0.26%",
}, {
...
add("summary-safe", "ROWS", "GOLD", {
  ...
  rows: [
    ...
    { color:"#94a3b8", fill:"#0c1017", right:"할인", title:"금리가 오르면 금·비트코인 같은 무이자 자산의 기회비용이 커집니다",
      sub:"자산마다 움직이는 속도가 다릅니다. 금리 하루가 금·코인·유가에 각각 닿습니다." },
  ],
...
add("btc-safe", "L1", "BTC", {
  ...
  quote: "금리가 오르면 이자를 안 주는 자산의 매력이 떨어집니다. 7만 7천~7만 8천 달러권에서 8만 달러 회복에 실패했습니다. 다음에 보면 좋은 것은 소비자물가입니다.",
...
add("gold-safe", "L2", "GOLD", {
  ...
  heroSub: "현물 금은 온스당 약 4,365달러권으로 거론됐습니다. 10년물 4.92%가 실질금리 부담입니다. 8월 금 ETF 유입 180억 달러는 한 달 흐름이고, 오늘 온스는 하루 가격입니다.",
  cards: [
  ...
  detailHead: "온스와 금리가 보여 주는 것",
  detailLines: ["📍 현물 온스는 약 4,365달러입니다","📈 10년 4.92%가 금을 누르는 이자입니다","🛢️ 브렌트 101달러는 에너지 가격입니다"],
  noteSub: "금은 비트코인보다 천천히 움직입니다. 브렌트 100달러는 에너지 뉴스입니다. 장기적으로 실질금리가 금 가격의 큰 축입니다.",
  footer: "금 · 온스 4,365",
}, {
...
add("eth-safe", "L3", "ETH", {
  ...
  heroSub: "이더리움은 스마트계약 네트워크의 토큰입니다. 약 2,460달러권으로 비트코인보다 조금 더 약할 수 있습니다. 비트코인보다 조금 더 약할 수 있는 하루입니다.",
  cards: [
    { icon:"💵", big:"~2,460", mid:"달러 구간", sub:"집계마다 조금 다름" },
    { icon:"₿", big:"BTC", mid:"베타", sub:"할인율이 같이 움직임" },
    { icon:"📉", big:"레버", mid:"알트 포지션", sub:"먼저 줄일 칸" },
  ],
  quote: "이더리움은 비트코인 할인을 더 크게 받는 경우가 많습니다. 약 2,460달러권이 오늘 구간입니다. 다음에 보면 좋은 것은 소비자물가입니다.",
  noteSub: "오늘 가격은 금리 할인율에 더 가깝습니다. 장기적으로 스마트계약 수요가 이 네트워크의 힘입니다.",
  footer: "이더리움 · 2,460권",
}, {
...
add("oil-safe", "L6", "OIL", {
  ...
  grid: [
    ...
    { icon:"🌍", big:"중동", mid:"중동 긴장 프리미엄", sub:"재고와 외교가 같이 있습니다" },
  ],
  ctx1: "유가 상승은 생산자물가 5.4%와 같은 아침입니다. 공장이 내보내는 가격에도 에너지가 들어갑니다.",
  ctx2: "금·비트코인과 달리 유가는 쓰는 연료 가격입니다.",
  quote: "101.21달러는 7월 23일 이후 첫 종가 100달러입니다. 다음에 보면 좋은 것은 주간 재고입니다.",
  noteSub: "유가는 물가에 들어가는 연료입니다. 공급 차질이 이어지면 에너지 비중이 커질 수 있습니다. 장기적으로 중동 일정과 재고가 가격을 만듭니다.",
...
add("rates-safe", "L1", "RATES", {
  ...
  quote: "10년물 4.92%와 생산자물가 5.4%가 같은 주입니다. 금·비트코인 할인율이 같이 올라갑니다. 다음에 보면 좋은 것은 소비자물가입니다.",
...
add("summary-krre", "ROWS", "POLICY", {
  ...
  rows: [
    ...
    { color:"#4ade80", fill:"#061209", right:"입주", title:"서초 전세 약세는 잠원·반포 입주 영향으로 설명됐습니다",
      sub:"4주 연속 하락입니다. 잠원·반포 입주가 전세를 눌렀다는 설명입니다." },
    { color:"#94a3b8", fill:"#0c1017", right:"계약", title:"구별 실거래와 전세대출 한도가 계약 관문입니다",
      sub:"구별 실거래와 전세대출 한도를 먼저 보시면 됩니다." },
  ],
...
add("seoul-split-krre", "L5", "POLICY", {
  ...
  quote: "서울 평균 +0.20% 안에 강북 +0.33%와 강남3구 하락이 갈렸습니다. 다음에 보면 좋은 것은 구별 실거래입니다.",
  noteSub: "세제 불확실성이 강남 고가에 더 붙었다는 설명이 있습니다. 장기적으로 학군·직주 수요가 가격보다 천천히 움직입니다.",
  footer: "서울 · 강남·강북 키맞춤",
}, {
...
add("gangnam3-down-krre", "L1", "POLICY", {
  ...
  quote: "세 구가 같이 내렸지만 강북 14개구는 +0.33%입니다. 다음에 보면 좋은 것은 실제로 체결되는 호가입니다.",
  noteSub: "고가·비거주 세제 불확실성이 거론됐습니다. 서초 전세 −0.21%는 입주 물량 쪽입니다. 장기적으로 재건축 일정이 가격보다 천천히 움직입니다.",
  footer: "강남3구 · 동반 하락",
}, {
...
add("nowon-jeonse-krre", "L2", "JEONSE", {
  ...
  detailHead: "전세를 구별로 보면",
  detailLines: ["📍 서울 전세 평균은 +0.19%입니다","🏗 서초는 잠원·반포 입주 영향입니다","💵 가을 이사 때는 전세대출 한도를 먼저 봅니다"],
  noteSub: "노원 전세 +0.38%와 서초 전세 −0.21%가 같은 주의 다른 구입니다. 가을 이사에는 전세대출 한도가 관문입니다. 장기적으로 입주 일정이 전세 온도를 만듭니다.",
  footer: "전세 · 노원 vs 서초",
}, {
...
add("seoul-supply-krre", "L6", "POLICY", {
  ...
  ctx1: "서울 한 달 공급이 이 단지에 가깝다는 설명이 있습니다. 일반이 살 수 있는 집은 29세대입니다.",
  ctx2: "임의공급이라 청약통장 가점이 없습니다. 추첨입니다.",
  quote: "85세대는 단지 규모이고 일반분양은 29세대입니다. 계약은 9월 11~12일입니다. 다음에 보면 좋은 것은 계약률입니다.",
  noteSub: "후분양은 공정을 보고 들어가는 단지입니다. 서울 입주가 적으면 전세가 오를 여지가 있습니다. 입주는 2027년 1월입니다.",
  footer: "공급 · 목동 85세대",
}, {
