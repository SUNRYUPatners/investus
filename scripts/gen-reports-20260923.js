...
const P = {
  ...
  ASML:   { fg:"#38bdf8", fg2:"#0ea5e9", bg2:"#061520", card:"#0a1a26" },
  PLTR:   { fg:"#a78bfa", fg2:"#8b5cf6", bg2:"#120b1f", card:"#180f28" },
  OIL:    { fg:"#f97316", fg2:"#ea580c", bg2:"#1a0d02", card:"#20130a" },
  SILVER: { fg:"#94a3b8", fg2:"#64748b", bg2:"#0c1017", card:"#111827" },
  ETH:    { fg:"#818cf8", fg2:"#6366f1", bg2:"#0f1024", card:"#15162a" },
  AUTO:   { fg:"#fb7185", fg2:"#f43f5e", bg2:"#1a0a10", card:"#201018" },
  AAPL:   { fg:'#a1a1aa', fg2:'#71717a', bg2:'#0f0f10', card:'#141416' },
  AI:     { fg:'#a78bfa', fg2:'#8b5cf6', bg2:'#120b1f', card:'#180f28' },
  MSFT:   { fg:'#3b82f6', fg2:'#2563eb', bg2:'#06121f', card:'#0a1420' },
  ...
  XAI:    { fg:'#fb7185', fg2:'#f43f5e', bg2:'#1a0a10', card:'#201018' },
  MCD:    { fg:'#ffbb33', fg2:'#e58600', bg2:'#1a0e00', card:'#201408' },
  META:   { fg:'#60a5fa', fg2:'#3b82f6', bg2:'#06121f', card:'#0a1420' },
  ANTHROPIC: { fg:'#60a5fa', fg2:'#3b82f6', bg2:'#06121f', card:'#0a1420' },
  CRWV:   { fg:'#38bdf8', fg2:'#0ea5e9', bg2:'#061520', card:'#0a1a26' },
};
...
function L2(o, ko){
  ...
  const cards = o.cards.map((c, i) => {
    const x = [60, 390, 720][i];
    return `
  <rect x="${x}" y="400" width="300" height="200" rx="16" fill="${p.card}" stroke="${p.fg}" stroke-width="2"/>
  <text x="${x+150}" y="436" font-family="Arial" font-size="18" fill="#6b7280" text-anchor="middle">${esc(c.label)}</text>
${ml(c.big, x+150, 486, 30, 274, 1, 32, `font-family="Arial Black,Arial" font-size="30" font-weight="900" fill="${p.fg}" text-anchor="middle"`)}
${ml(c.mid, x+150, 524, 17, 272, 2, 21, `font-family="Arial" font-size="17" fill="#9ca3af" text-anchor="middle"`)}
...
${ml(o.title, 540, 108, 28, 970, 2, 36, `font-family="Arial Black,Arial" font-size="28" font-weight="900" fill="#f9fafb" text-anchor="middle"`)}
  <line x1="80" y1="152" x2="1000" y2="152" stroke="#1f2937" stroke-width="1"/>
  <text x="540" y="220" font-family="Arial" font-size="64" text-anchor="middle">${o.heroIcon}</text>
...
require('./topics-20260923-data.js')(add);
