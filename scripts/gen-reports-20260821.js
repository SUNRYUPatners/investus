...
{file:'treasury-q4-record-bond-buybacks-17b-added-jpm',symbol:'MACRO',
 ko:{title:'미국 재무부 Q4 국채 환매 사상 최대 규모로 확대·170억 달러 추가 buyback·JPM 지적 노트',heroIcon:'🏛️',heroBig:'+$17T',heroSub:'미국 재무부가 4분기에 사상 최대 규모의 국채 환매를 실시하고 있으며, 4분기에만 17조 달러 규모의 귀금속·크립토 시총 증가가 나타났다 (Bitcoin +12%·Gold +4%·US Dollar -7%). 재무부가 시장 유동성 개선을 위해 개입 규모를 대폭 확대하는 조치이며, 이는 이자 부담 감소와 시장 안정 목적으로 진행되고 있다.',
  cards:[{icon:'🏛️',big:'+$17T',mid:'Q4 추가 buyback',sub:'JPM 노트 예상'},{icon:'📊',big:'사상 최대',mid:'분기 환매 규모',sub:'유동성 개선 목적'},{icon:'💧',big:'시장 안정',mid:'재무부 개입 확대',sub:'이자 부담 감소'}],
  ...
  noteHead:'왜 중요한가',noteSub:'재무부 개입 규모가 정량으로 확인됐다. 8/20 국채 환매 40-50억 상한 확대·다중 십년 최고 수익률 배경 이후 실 규모가 사상 최대급이라는 사후 확인이다.',footer:'매크로 · Q4 재무부 환매 +$17T',brand:BK},
 en:{title:'US Treasury Announcement Adds $17T to Precious Metals and Crypto in 3 Hours · Bitcoin +12% · Gold +4% · USD -7%',heroIcon:'🏛️',heroBig:'+$17 T',heroSub:'US Treasury is conducting record-level bond buybacks in Q4, with JPM notes expecting an additional $17B in buybacks in Q4 alone. Treasury is expanding intervention scale to improve market liquidity, aimed at reducing interest burden and market stabilization.',
  cards:[{icon:'🏛️',big:'+$17 T',mid:'Q4 additional buyback',sub:'Per JPM note'},{icon:'📊',big:'Record',mid:'Quarterly buyback scale',sub:'Liquidity improvement'},{icon:'💧',big:'Market stability',mid:'Treasury intervention expanded',sub:'Interest burden reduction'}],
  ...
  noteHead:'Why this matters',noteSub:'Treasury intervention scale quantified. Following 8/20 buyback cap raised to $4-5B and multi-decade high yields backdrop, this is post-confirmation that actual scale is record-level.',footer:'MACRO · Treasury Announcement +$17T',brand:BE}},
...
{file:'us-10y-yield-522pct-bond-yields-drop-treasury',symbol:'MACRO',
 ko:{title:'미국 30년 국채 수익률 5.22% 아래로 하락·재무부 환매 확대 이후 시장 반응',heroIcon:'📉',heroBig:'5.22%',heroSub:'미국 30년 국채 수익률이 5.22%로 크게 하락했다. 재무부가 국채 환매를 대폭 확대하면서 이자 부담이 감소하고 시장이 반응한 결과다. 30년 국채 수익률도 함께 하락했다.',
  cards:[{icon:'📉',big:'5.22%',mid:'미국 30년 국채 수익률',sub:'화요일 5.337% 이후 급락'},{icon:'📊',big:'수익률 하락',mid:'재무부 환매 반응',sub:'이자 부담 감소'},{icon:'💰',big:'30년물 동반',mid:'장기 채권 하락',sub:'시장 안정 신호'}],
  quote:'"미국 10년 국채 수익률이 5.22%로 큰 폭 하락했다. 재무부가 국채 환매를 대폭 확대하면서 이자 부담이 감소했고 시장이 이에 반응했다. 30년 국채도 함께 하락했다."',
  noteHead:'왜 중요한가',noteSub:'재무부 환매 확대가 실 시장 반응으로 확인된 첫 지표다. 8/20 재무부 환매 40-50억·Q4 170억 프레임의 실 효과가 나타나는 시점이다.',footer:'매크로 · US 30Y 5.22%',brand:BK},
 en:{title:'US 30-Year Treasury Yield Drops Below 5.22% · Tuesday 5.337% (Highest Since 2007) · 5.18% Within Hour After Treasury Doubled Auction/Buybacks',heroIcon:'📉',heroBig:'5.22%',heroSub:'US 30-year Treasury yield dropped below 5.22%. Rose to 5.337% Tuesday (highest since 2007) but fell to 5.18% within an hour after Treasury doubled auction size and buybacks.',
  cards:[{icon:'📉',big:'5.22%',mid:'US 30Y Treasury yield',sub:'From Tuesday 5.337%'},{icon:'📊',big:'Yield drop',mid:'Treasury buyback reaction',sub:'Interest burden decrease'},{icon:'💰',big:'30Y also',mid:'Long bonds decline',sub:'Market stability signal'}],
  ...
  noteHead:'Why this matters',noteSub:'First indicator confirming Treasury buyback expansion in real market reaction. Real effect of 8/20 buyback $4-5B / Q4 $17B frame emerges.',footer:'MACRO · US 30Y 5.22%',brand:BE}},
...
// 12. JPM Analyst SPCX 500K + AI CAPEX 2027 $1.9T (Compute $685B·DC $308B)
{file:'jpm-ai-capex-2027-185b-cybercab-spx-analyst',symbol:'MACRO',
 ko:{title:'AI CAPEX 2027년 1.9조 달러 (Compute 6,850억·DC 3,080억) 예상·주요 하이퍼스케일러 인프라 확장 지속',heroIcon:'💻',heroBig:'1,850억',heroSub:'애널리스트들이 2027년 AI CAPEX 규모를 1.9조 달러 (Compute 6,850억·DC 3,080억)로 전망한다. 주요 하이퍼스케일러와 파트너 회사들이 데이터센터·GPU·전력 인프라에 지속 대량 투자하는 흐름이며, 이는 2026년 대비 대폭 증가한 수치다.',
  cards:[{icon:'💻',big:'1.9조 달러 (Compute 6,850억·DC 3,080억)',mid:'2027년 AI CAPEX',sub:'전망 규모'},{icon:'📈',big:'대폭 증가',mid:'2026 대비',sub:'인프라 확장 지속'},{icon:'🏢',big:'하이퍼스케일러',mid:'데이터센터·GPU·전력',sub:'주요 투자 대상'}],
  quote:'"애널리스트들이 2027년 AI CAPEX 규모를 1.9조 달러 (Compute 6,850억·DC 3,080억)로 전망한다. 주요 하이퍼스케일러와 파트너 회사들이 데이터센터·GPU·전력 인프라에 지속 대량 투자한다는 프레임이다."',
  noteHead:'왜 중요한가',noteSub:'8/12 NVDA + SPCX 2,600억 GPU 딜·8/11 NVDA 5,000억 컨소시엄·오늘 별개 리포트의 Musk MacHarder 100K GPU와 결합해 AI CAPEX 사이클이 2027년까지 확장된다.',footer:'매크로 · AI CAPEX 2027 · 1.9조',brand:BK},
 en:{title:'AI CAPEX Expected to Reach $1.9T (Compute $685B·DC $308B) in 2027 · Major Hyperscaler Infrastructure Expansion Continues',heroIcon:'💻',heroBig:'$1.9 T',heroSub:'Analysts forecast 2027 AI CAPEX to reach $1.9T (Compute $685B·DC $308B). Major hyperscalers and partner companies continue heavy investment in data centers, GPUs, and power infrastructure · significantly larger than 2026.',
  cards:[{icon:'💻',big:'$1.9 T',mid:'2027 AI CAPEX',sub:'Forecast scale'},{icon:'📈',big:'Big increase',mid:'vs 2026',sub:'Infra expansion continues'},{icon:'🏢',big:'Hyperscalers',mid:'DC/GPU/power',sub:'Main investment targets'}],
  quote:'"Analysts forecast 2027 AI CAPEX to reach $1.9T (Compute $685B·DC $308B). Major hyperscalers and partner companies continue heavy investment in data centers, GPUs, and power infrastructure."',
  noteHead:'Why this matters',noteSub:'Combined with 8/12 NVDA + SPCX $260B GPU deal / 8/11 NVDA $500B consortium / today Musk MacHarder 100K GPU, AI CAPEX cycle expands through 2027.',footer:'MACRO · AI CAPEX 2027 · $1.9T (Compute $685B·DC $308B)',brand:BE}},

// 13. WTI oil doubling · gas prices
{file:'wti-oil-double-order-gas-prices-385-gallon',symbol:'MACRO',
 ko:{title:'미국 휘발유 가격 갤런당 $4.10 (regular)·디젤 $5.50 초과·유가 급등 압력 지속·2028년 이후 최고 수준',heroIcon:'⛽',heroBig:'$4.10/gal (regular)',heroSub:'미국 국내 평균 휘발유 가격이 갤런당 $4.10 (regular)·디젤 $5.50 초과까지 오르면서 소비자 지출 부담이 증가하고 있다. 유가 급등 압력이 지속되면서 2028년 이후 최고 수준이며, 원유·정제 시장의 공급 부족이 요인으로 지적된다.',
  cards:[{icon:'⛽',big:'$4.10/gal (regular)',mid:'미국 휘발유 가격',sub:'2028 이후 최고'},{icon:'📈',big:'유가 급등',mid:'원유·정제 공급 부족',sub:'가격 압력 지속'},{icon:'💵',big:'소비자 부담',mid:'지출 증가 요인',sub:'매크로 리스크'}],
  quote:'"미국 국내 평균 휘발유 가격이 갤런당 $4.10 (regular)·디젤 $5.50 초과까지 오르며 2028년 이후 최고 수준을 기록했다. 원유·정제 시장의 공급 부족이 요인이며, 소비자 지출 부담이 증가하고 있다."',
  noteHead:'왜 중요한가',noteSub:'매크로 리스크의 실 신호다. 8/17 미국 국가 부채 39.94조·오늘 별개 리포트의 재무부 환매 확대와 결합해 소비자·기업 비용 부담이 다층 확장된다.',footer:'매크로 · 휘발유 $4.10/gal (regular)',brand:BK},
 en:{title:'US Gasoline Prices Hit $3.85/Gallon · Sustained Oil Price Pressure · Highest Since 2028',heroIcon:'⛽',heroBig:'$4.10/GAL',heroSub:'US national average gasoline price rose to $4.10 per gallon (regular) · diesel over $5.50, increasing consumer spending burden. Oil price pressure sustains at highest level since 2028, with crude oil and refining market supply shortage as cited factor.',
  cards:[{icon:'⛽',big:'$4.10/gal (regular)',mid:'US gasoline price',sub:'Highest since 2028'},{icon:'📈',big:'Oil surge',mid:'Crude/refining supply shortage',sub:'Price pressure sustains'},{icon:'💵',big:'Consumer burden',mid:'Spending increase factor',sub:'Macro risk'}],
  quote:'"US national average gasoline price rose to $4.10 per gallon (regular) · diesel over $5.50, reaching highest level since 2028. Crude oil and refining supply shortage is cited factor · consumer spending burden increasing."',
  noteHead:'Why this matters',noteSub:'Real signal of macro risk. Combined with 8/17 US debt $39.94T and today Treasury buyback expansion, consumer and business cost burden expands multi-layer.',footer:'MACRO · Gasoline $4.10/gal (regular)',brand:BE}},

// 14. Model Y sales surge 200% MoM
{file:'tsla-model-y-sales-surge-200pct-mom-strongest',symbol:'TSLA',
 ko:{title:'Tesla Model Y 인도 판매 전월 대비 300% 급증·인도 시장 진입 가속 판매 실적',heroIcon:'📈',heroBig:'+300%',heroSub:'Tesla Model Y 판매가 인도에서 전월 대비 300% 급증했다는 관측이다. Tesla가 인도 시장 진입 이후, 이는 8/17 중국 7월 +33%·오늘 별개 리포트의 Model Y 한국 1위와 결합해 아시아·미국 시장에서 Model Y 판매가 다각 회복되고 있다는 신호다.',
  cards:[{icon:'📈',big:'+200%',mid:'Model Y 인도 전월 대비',sub:'MoM 300% 급증'},{icon:'📅',big:'최근 개월',mid:'가장 강한 판매 실적',sub:'회복 확인'},{icon:'🌏',big:'다각 회복',mid:'중국·한국·미국',sub:'국제 확장 정합'}],
 ...
 en:{title:'Tesla Model Y India Sales Surge 300% MoM · India Market Entry Acceleration',heroIcon:'📈',heroBig:'+300%',heroSub:'Tesla Model Y sales surged 300% month-over-month in India. Strongest sales result in recent months. Combined with 8/17 China July +33% and today Model Y Korea #1, Model Y sales are recovering multi-axis across Asia and US.',
