...
add('starlink-router-4', 'L2', 'SPCX', {
  ...
  detailLines: ['📍 와이파이 7은 단말 규격이지 위성 속도가 아님','📶 510대는 동시 접속 상한','💵 요금제 속도와 다른 화면의 숫자입니다'],
  noteSub: '단말 스펙은 실내 와이파이 성능입니다. 스타링크 다이렉트 확장·스펙트럼 허가와 다른 화면의 숫자입니다. 다음 확인할 것은 출하와 실제 속도입니다. 장기적으로 설치가 쉬워지면 가입 전환 비용이 낮아질 수 있습니다.',
  footer: '스페이스X · 라우터 4',
}, {
...
add('cybercab-cd-165', 'L1', 'TSLA', {
  ...
  noteSub: '스펙은 양산 원가가 아닙니다. 골드만 마일당 원가 서사와 다른 화면의 숫자입니다. 다음 게이트는 시험 전비와 출고가입니다. 장기적으로 전비가 낮으면 로보택시 완전 원가가 내려갈 수 있습니다.',
  footer: '테슬라 · 사이버캡 전비',
}, {
...
add('tsla-fsd-awesome', 'L3', 'TSLA', {
  ...
  noteSub: '발언은 평가이지 규제 승인이 아닙니다. 라이더 가이드·유타 7대와 다른 화면의 숫자입니다. 다음 게이트는 공개 개입률입니다. 장기적으로 개입이 줄면 감독 없는 운행 가정이 두꺼워질 수 있습니다.',
  footer: '테슬라 · 완전자율주행',
}, {
...
add('spcx-starship-revenue', 'L5', 'SPCX', {
  ...
  noteSub: '시험 성공과 매출 인식은 시계가 다릅니다. 부스터 22호기 극저온 시험과 다른 화면의 숫자입니다. 다음 확인할 것은 페이로드 고객입니다. 장기적으로 케이던스가 붙으면 발사 단가가 내려갈 수 있습니다.',
  footer: '스페이스X · 스타십 매출',
}, {
...
add('nvda-pltr-stack', 'L6', 'NVDA', {
  ...
  ctx2: '내부자 6억 달러 매도와 다른 화면의 숫자입니다.',
  quote: '가장 중요하다는 말은 평가입니다. 수주 공시가 나오기 전에는 수주가 나오면 더 분명해집니다. 다음 확인할 것은 공동 레퍼런스입니다.',
  noteSub: '주권 인공지능은 국가가 데이터를 국내에 두는 그림입니다. 자그레브 무인 22km와 다른 화면의 숫자입니다. 다음 게이트는 계약 규모입니다. 장기적으로 소프트웨어가 붙으면 칩 교체 비용이 커질 수 있습니다.',
  footer: '엔비디아 · 팔란티어',
}, {
...
add('ust-10y-492', 'L1', 'RATES', {
  ...
  quote: '금리가 오르면 주식·비트코인 할인율이 같이 올라갑니다. 바이백 규모와 한 줄의 완화로 따로 보시면 됩니다. 다음 확인할 것은 소비자물가입니다.',
...
add('slovenia-fsd-free', 'L3', 'TSLA', {
  ...
  quote: '무상 기간은 체험 프로모션입니다. 97.2% 스트릭·자그레브 무인과 다른 화면의 숫자입니다. 다음 확인할 것은 전환율입니다.',
...
add('xai-dc-overhaul', 'L4', 'SPCX', {
  ...
  quote: '재설계는 자본지출 일정이지 학습 성능 확정이 아닙니다. 궤도 컴퓨팅 위성과 다른 화면의 숫자입니다. 다음 확인할 것은 가동률입니다.',
...
add('sh22-cryo-f15', 'L2', 'SPCX', {
  ...
  noteSub: '지상 시험 통과는 발사 허가가 아닙니다. 다음 스타십 매출 비행 발언과 다른 화면의 숫자입니다. 다음 게이트는 정적 화재와 발사 창입니다. 장기적으로 재사용 부스터가 늘면 발사 단가가 내려갑니다.',
  footer: '스페이스X · 부스터 22',
}, {
...
add('boring-3b-23b', 'L5', 'TSLA', {
  ...
  quote: '조달과 터널 킬로미터는 다른 칸입니다. 착공·개통 전에 기업가치를 확정 수요로 아직 그 단계는 아닙니다. 테슬라 시총과 따로 보시면 됩니다.',
...
add('robotaxi-app-hue', 'L3', 'TSLA', {
  ...
  quote: '색을 맞춘 것은 제품 다듬기입니다. 유타 7대·텍사스 등록과 다른 화면의 숫자입니다. 다음 확인할 것은 유료 호출 도시입니다.',
...
add('terafab-foundation', 'L2', 'SPCX', {
  ...
  noteSub: '기초 진척은 일정 힌트이지 수율 확정이 아닙니다. 엑스에이아이 데이터센터 재설계와 다른 화면의 숫자입니다. 다음 확인할 것은 장비 반입입니다. 장기적으로 공장이 돌면 패키지 병목이 줄어들 수 있습니다.',
  footer: '스페이스X · 테라팹',
}, {
...
add('pony-zagreb-nvda', 'L6', 'NVDA', {
  ...
  ctx1: '시연은 유료 호출이 아닙니다. 테슬라 사이버캡 배치와 다른 화면의 숫자입니다.',
  ctx2: '팔란티어 엔터프라이즈 발언과 한 문장에 넣지 마시기 바랍니다.',
  quote: '22km는 한 경로의 시연입니다. 유럽 전역 허가로 아직 그 단계는 아닙니다. 다음 확인할 것은 반복 운행과 요금입니다.',
  noteSub: '엔비디아 드라이브는 칩·소프트웨어 공급입니다. 차량 회사의 대수와 다른 화면의 숫자입니다. 다음 게이트는 상용 지오펜스입니다. 장기적으로 유럽 허가가 늘면 드라이브 탑재 대수가 따라갈 수 있습니다.',
...
add('cybercab-rider-guide', 'L3', 'TSLA', {
  ...
  quote: '안내서는 제품 준비입니다. 앱 색·유타 7대와 다른 화면의 숫자입니다. 다음 확인할 것은 호출이 열리는 도시입니다.',
  noteSub: '문서가 나왔다고 요금표가 있는 것은 아닙니다. 슬로베니아 무상 완전자율주행과 다른 화면의 숫자입니다. 다음 게이트는 실제 탑승 규정입니다. 장기적으로 안내가 표준이 되면 보험·규제 대화가 쉬워질 수 있습니다.',
  footer: '테슬라 · 라이더 가이드',
}, {
...
add('utah-7-cybercab', 'L2', 'TSLA', {
  ...
  noteSub: '7대는 현지 목격이지 주 전체 등록이 아닙니다. 텍사스 437대 서사와 다른 화면의 숫자입니다. 다음 확인할 것은 유타 허가입니다. 장기적으로 주가 늘면 전용차 공급 지도가 넓어집니다.',
  footer: '테슬라 · 유타 7대',
}, {
...
add('optimus-germany', 'L4', 'TSLA', {
  ...
  quote: '채용은 공장 준비입니다. 부품 5,000대 발주와 다른 화면의 숫자입니다. 다음 확인할 것은 라인 가동입니다.',
...
add('starlink-direct-expand', 'L6', 'SPCX', {
  ...
  noteSub: '커버 국가가 늘면 로밍 대체가 생깁니다. 라우터 4 스펙과 다른 화면의 숫자입니다. 다음 게이트는 실제 개통 공지입니다. 장기적으로 다이렉트가 기본이 되면 위성 통신 해자가 두꺼워질 수 있습니다.',
...
add('nvda-insider-600m', 'L1', 'NVDA', {
  ...
  noteSub: '두 건의 공시를 합친 규모입니다. 주권 인공지능 그림과 다른 화면의 숫자입니다. 다음 게이트는 다음 분기 실적입니다. 장기적으로 수요가 유지되면 내부자 매도는 수급 칸에만 남습니다.',
  footer: '엔비디아 · 내부자 매도',
}, {
...
add('blackrock-tsla-6m', 'L1', 'TSLA', {
  ...
  heroIcon: '🏦', heroBig: '6M',
  heroSub: '블랙록은 세계 큰 자산운용사입니다. 2분기 공시에 테슬라 보통주 600만 주 매수가 찍혔습니다. 하루 종가와 다른 화면의 숫자입니다.',
  cards: [
  ...
  noteSub: '2분기 숫자는 이미 지난 스냅샷입니다. 3분기 플릿 실측과 다른 화면의 숫자입니다. 다음 게이트는 다음 공시입니다. 장기적으로 패시브 비중이 커지면 수급 변동이 지수와 같이 움직입니다.',
  footer: '테슬라 · 블랙록 600만',
}, {
...
add('spcx-orbital-compute', 'L4', 'SPCX', {
  ...
  heroIcon: '💻', heroBig: '내년',
  heroSub: '궤도 컴퓨팅은 지상 데이터센터 대신 위성에서 연산을 돌리는 그림입니다. 재무담당이 내년에 첫 위성을 올리겠다고 했습니다. 별자리 완성 연도와 다른 화면의 숫자입니다.',
  cards: [
    { icon:'📅', big:'내년', mid:'첫 위성', sub:'시제·실증 단계' },
    { icon:'🛰', big:'궤도', mid:'우주에서 연산', sub:'지상 전력과 다른 축' },
    { icon:'💵', big:'CFO', mid:'재무 발언', sub:'수주 공시가 아님' },
  ],
  quote: '첫 위성은 실증입니다. 스타십 매출 비행·데이터센터 재설계와 다른 화면의 숫자입니다. 다음 확인할 것은 발사 매니페스트입니다.',
...
add('congress-spcx-buy', 'L4', 'SPCX', {
  ...
  quote: '의회 매수는 관심 신호입니다. 락업 3.19억 주·종가와 다른 화면의 숫자입니다. 다음 확인할 것은 추가 공시입니다.',
