...
add('starbase-water-rights', 'L2', 'SPCX', {
  ...
  noteSub: '로켓 회사의 경쟁력은 「몇 번 발사했는가」와 「어디서 더 자주 쏠 수 있는가」로 나뉩니다. 수자원·토지 확보는 캐파 확장의 전조입니다. 거래가 확정되면 발사 cadence 목표와 맞춰 보시면 됩니다. 물·환경 규제는 지역 확장의 숨은 변수이기도 합니다.',
...
add('arkk-tsla-spcx-flow', 'L2', 'MACRO', {
  ...
  noteSub: '개별 종목 뉴스보다 ETF 자금 흐름은 「테마 전체에 돈이 들어오는지」를 보여 줍니다. 같은 날 ARKK·TSLA·SPCX 관련 흐름이 같이 움직이면 혁신·우주·AI가 한 basket으로 거래되고 있다는 뜻입니다. 다음 주에는 사이버캡 행사 전후 TSLA 옵션·ETF 유입을 함께 보시면 됩니다.',
...
add('silver-safe', 'L1', 'GOLD', {
  ...
  cards: [
    ...
    { icon:'🥇', big:'금 연동',   mid:'귀금속 basket',     sub:'투자·헤지 수요' },
