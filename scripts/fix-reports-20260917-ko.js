...
const REPORTS = [
  { id: "seed-1690", slug: "summary", pinned: true, bodyOnly: true,
    ...
    summary: "연준이 새 의장 케빈 워시 취임 첫 회의에서 12명 전원 찬성으로 기준금리를 3.75~4.00%로 올렸습니다. 스페이스X는 스타십 14차 비행(9/22) 발표에 시가총액이 500억 달러 넘게 뛰었고, 테슬라는 노르웨이에서 등록 차량 20만대를 돌파했습니다. 모건스탠리는 엔비디아의 HBM 수요 점유율을 37.3%로 추산했고, SK하이닉스는 인텔 오하이오 공장을 빌려 미국 내 첫 메모리 생산을 검토합니다.",
