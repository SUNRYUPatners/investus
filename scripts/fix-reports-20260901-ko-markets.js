#!/usr/bin/env node
/** 2026-09-01 KR / Safe / KR-RE reports — English skeleton → full Korean */
const fs = require('fs');
const path = require('path');

const DATA = require('./topics-20260901-kr-markets-data.js');
...
function reportBlock(r, useBodyHelper) {
  const img = `/charts/${r.slug}-20260901.svg`;
  const imgEn = `/charts/${r.slug}-20260901-en.svg`;
