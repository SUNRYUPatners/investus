        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-4 mb-3">
            <div className="flex items-center gap-1">
              <TrendingUp className="w-3 h-3" style={{ color: "var(--up)" }} />
              <span className="text-xs font-bold font-mono-num" style={{ color: "var(--up)" }}>
                +{annualReturn}%
              </span>
          ...
          <div className="flex gap-1.5 mb-4 flex-wrap">
            {topHoldings.map((h) => (
              <span key={h.symbol} className="text-[10px] font-mono-num font-bold px-2 py-1 rounded-lg"
                ...
                {h.symbol}
                <span className="ml-1" style={{ color: h.avgReturn >= 0 ? "var(--up)" : "var(--down)" }}>
